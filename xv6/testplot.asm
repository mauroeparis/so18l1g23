...
_testplot:     file format elf32-i386
...
main(void)
{
  ...
  10:	51                   	push   %ecx
  int img[] = {
  11:	8d bd 68 f3 ff ff    	lea    -0xc98(%ebp),%edi
  17:	be e0 07 00 00       	mov    $0x7e0,%esi
  1c:	b9 90 01 00 00       	mov    $0x190,%ecx
{
  21:	81 ec 94 0c 00 00    	sub    $0xc94,%esp
  int img[] = {
  ...
  int img1[] = {
  29:	be 20 0e 00 00       	mov    $0xe20,%esi
  2e:	b9 90 01 00 00       	mov    $0x190,%ecx
  33:	8d bd a8 f9 ff ff    	lea    -0x658(%ebp),%edi
  39:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  ...
  modeswitch(1);
  3b:	6a 01                	push   $0x1
  3d:	8d bd 68 f3 ff ff    	lea    -0xc98(%ebp),%edi

  int i, j;
  for(j=100;j<119;++j)
  43:	be 64 00 00 00       	mov    $0x64,%esi
  modeswitch(1);
  48:	e8 7d 03 00 00       	call   3ca <modeswitch>
  4d:	83 c4 10             	add    $0x10,%esp
    for(i=100; i<119; ++i)
  50:	bb 64 00 00 00       	mov    $0x64,%ebx
  55:	8d 76 00             	lea    0x0(%esi),%esi
      plotpixel(i,j,img[(j-100)*20+(i-100)]);
  58:	83 ec 04             	sub    $0x4,%esp
  5b:	ff b4 9f 70 fe ff ff 	pushl  -0x190(%edi,%ebx,4)
  62:	56                   	push   %esi
  63:	53                   	push   %ebx
    for(i=100; i<119; ++i)
  64:	83 c3 01             	add    $0x1,%ebx
      plotpixel(i,j,img[(j-100)*20+(i-100)]);
  67:	e8 56 03 00 00       	call   3c2 <plotpixel>
    for(i=100; i<119; ++i)
  6c:	83 c4 10             	add    $0x10,%esp
  6f:	83 fb 77             	cmp    $0x77,%ebx
  72:	75 e4                	jne    58 <main+0x58>
  for(j=100;j<119;++j)
  74:	83 c6 01             	add    $0x1,%esi
  77:	83 c7 50             	add    $0x50,%edi
  7a:	83 fe 77             	cmp    $0x77,%esi
  7d:	75 d1                	jne    50 <main+0x50>
  7f:	8d bd a8 f9 ff ff    	lea    -0x658(%ebp),%edi

  for(j=100;j<119;++j)
  85:	be 64 00 00 00       	mov    $0x64,%esi
  8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(i=130; i<149; ++i)
  90:	bb 82 00 00 00       	mov    $0x82,%ebx
  95:	8d 76 00             	lea    0x0(%esi),%esi
      plotpixel(i,j,img1[(j-100)*20+(i-130)]);
  98:	83 ec 04             	sub    $0x4,%esp
  9b:	ff b4 9f f8 fd ff ff 	pushl  -0x208(%edi,%ebx,4)
  a2:	56                   	push   %esi
  a3:	53                   	push   %ebx
    for(i=130; i<149; ++i)
  a4:	83 c3 01             	add    $0x1,%ebx
      plotpixel(i,j,img1[(j-100)*20+(i-130)]);
  a7:	e8 16 03 00 00       	call   3c2 <plotpixel>
    for(i=130; i<149; ++i)
  ac:	83 c4 10             	add    $0x10,%esp
  af:	81 fb 95 00 00 00    	cmp    $0x95,%ebx
  b5:	75 e1                	jne    98 <main+0x98>
  for(j=100;j<119;++j)
  b7:	83 c6 01             	add    $0x1,%esi
  ba:	83 c7 50             	add    $0x50,%edi
  bd:	83 fe 77             	cmp    $0x77,%esi
  c0:	75 ce                	jne    90 <main+0x90>

  exit();
  c2:	e8 5b 02 00 00       	call   322 <exit>
  c7:	66 90                	xchg   %ax,%ax
  c9:	66 90                	xchg   %ax,%ax
  cb:	66 90                	xchg   %ax,%ax
  cd:	66 90                	xchg   %ax,%ax
 ...
 3e9:	85 d2                	test   %edx,%edx
{
 ...
 417:	f7 f1                	div    %ecx
 419:	0f b6 92 68 14 00 00 	movzbl 0x1468(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb 60 14 00 00       	mov    $0x1460,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 18 17 00 00       	mov    0x1718,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 18 17 00 00       	mov    %eax,0x1718
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 18 17 00 00       	mov    %eax,0x1718
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 18 17 00 00    	mov    0x1718,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 18 17 00 00    	cmp    %eax,0x1718
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 18 17 00 00    	mov    0x1718,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 18 17 00 00    	mov    %edx,0x1718
}
 ...
 799:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7a0:	c7 05 18 17 00 00 1c 	movl   $0x171c,0x1718
 7a7:	17 00 00 
 7aa:	c7 05 1c 17 00 00 1c 	movl   $0x171c,0x171c
 7b1:	17 00 00 
    base.s.size = 0;
 7b4:	b8 1c 17 00 00       	mov    $0x171c,%eax
 7b9:	c7 05 20 17 00 00 00 	movl   $0x0,0x1720
 7c0:	00 00 00 
