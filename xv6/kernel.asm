...
80100028:	bc c0 d9 10 80       	mov    $0x8010d9c0,%esp
...
80100044:	bb f4 d9 10 80       	mov    $0x8010d9f4,%ebx
{
80100049:	83 ec 0c             	sub    $0xc,%esp
  initlock(&bcache.lock, "bcache");
8010004c:	68 20 78 10 80       	push   $0x80107820
80100051:	68 c0 d9 10 80       	push   $0x8010d9c0
80100056:	e8 95 41 00 00       	call   801041f0 <initlock>
  bcache.head.prev = &bcache.head;
8010005b:	c7 05 0c 21 11 80 bc 	movl   $0x801120bc,0x8011210c
80100062:	20 11 80 
  bcache.head.next = &bcache.head;
80100065:	c7 05 10 21 11 80 bc 	movl   $0x801120bc,0x80112110
8010006c:	20 11 80 
8010006f:	83 c4 10             	add    $0x10,%esp
80100072:	ba bc 20 11 80       	mov    $0x801120bc,%edx
...
801000aa:	8d 83 5c 02 00 00    	lea    0x25c(%ebx),%eax
    bcache.head.next = b;
801000b0:	89 1d 10 21 11 80    	mov    %ebx,0x80112110
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	3d bc 20 11 80       	cmp    $0x801120bc,%eax
...
801000dc:	8b 7d 0c             	mov    0xc(%ebp),%edi
  acquire(&bcache.lock);
801000df:	68 c0 d9 10 80       	push   $0x8010d9c0
801000e4:	e8 f7 41 00 00       	call   801042e0 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
801000e9:	8b 1d 10 21 11 80    	mov    0x80112110,%ebx
801000ef:	83 c4 10             	add    $0x10,%esp
801000f2:	81 fb bc 20 11 80    	cmp    $0x801120bc,%ebx
801000f8:	75 11                	jne    8010010b <bread+0x3b>
801000fa:	eb 24                	jmp    80100120 <bread+0x50>
801000fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100100:	8b 5b 54             	mov    0x54(%ebx),%ebx
80100103:	81 fb bc 20 11 80    	cmp    $0x801120bc,%ebx
...
80100120:	8b 1d 0c 21 11 80    	mov    0x8011210c,%ebx
80100126:	81 fb bc 20 11 80    	cmp    $0x801120bc,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 60                	jmp    80100190 <bread+0xc0>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb bc 20 11 80    	cmp    $0x801120bc,%ebx
...
8010015d:	68 c0 d9 10 80       	push   $0x8010d9c0
...
801001ff:	e8 7c 3f 00 00       	call   80104180 <releasesleep>
  ...
  acquire(&bcache.lock);
80100204:	c7 04 24 c0 d9 10 80 	movl   $0x8010d9c0,(%esp)
...
8010022f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100232:	a1 10 21 11 80       	mov    0x80112110,%eax
    b->prev = &bcache.head;
80100237:	c7 43 50 bc 20 11 80 	movl   $0x801120bc,0x50(%ebx)
    b->next = bcache.head.next;
8010023e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100241:	a1 10 21 11 80       	mov    0x80112110,%eax
80100246:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100249:	89 1d 10 21 11 80    	mov    %ebx,0x80112110
  }
  
  release(&bcache.lock);
8010024f:	c7 45 08 c0 d9 10 80 	movl   $0x8010d9c0,0x8(%ebp)
}
...
80100280:	e8 eb 14 00 00       	call   80101770 <iunlock>
  target = n;
  acquire(&cons.lock);
80100285:	c7 04 24 20 c9 10 80 	movl   $0x8010c920,(%esp)
...
801002a1:	8b 15 a0 23 11 80    	mov    0x801123a0,%edx
801002a7:	39 15 a4 23 11 80    	cmp    %edx,0x801123a4
...
801002bb:	68 20 c9 10 80       	push   $0x8010c920
801002c0:	68 a0 23 11 80       	push   $0x801123a0
801002c5:	e8 c6 3a 00 00       	call   80103d90 <sleep>
    while(input.r == input.w){
801002ca:	8b 15 a0 23 11 80    	mov    0x801123a0,%edx
801002d0:	83 c4 10             	add    $0x10,%esp
801002d3:	3b 15 a4 23 11 80    	cmp    0x801123a4,%edx
...
801002ea:	68 20 c9 10 80       	push   $0x8010c920
...
80100313:	a3 a0 23 11 80       	mov    %eax,0x801123a0
80100318:	89 d0                	mov    %edx,%eax
8010031a:	83 e0 7f             	and    $0x7f,%eax
8010031d:	0f be 80 20 23 11 80 	movsbl -0x7feedce0(%eax),%eax
    if(c == C('D')){  // EOF
...
80100348:	68 20 c9 10 80       	push   $0x8010c920
...
80100370:	73 d0                	jae    80100342 <consoleread+0xd2>
        input.r--;
80100372:	89 15 a0 23 11 80    	mov    %edx,0x801123a0
...
80100398:	fa                   	cli    
  cons.locking = 0;
80100399:	c7 05 54 c9 10 80 00 	movl   $0x0,0x8010c954
801003a0:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003c0:	e8 9b 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003c5:	c7 04 24 af 91 10 80 	movl   $0x801091af,(%esp)
...
801003f9:	c7 05 58 c9 10 80 01 	movl   $0x1,0x8010c958
80100400:	00 00 00 
...
80100410 <consputc>:
  if(panicked){
80100410:	8b 0d 58 c9 10 80    	mov    0x8010c958,%ecx
...
8010060f:	e8 5c 11 00 00       	call   80101770 <iunlock>
  acquire(&cons.lock);
80100614:	c7 04 24 20 c9 10 80 	movl   $0x8010c920,(%esp)
...
80100642:	68 20 c9 10 80       	push   $0x8010c920
...
80100669:	a1 54 c9 10 80       	mov    0x8010c954,%eax
  if(locking)
...
8010071a:	68 20 c9 10 80       	push   $0x8010c920
...
801007eb:	68 20 c9 10 80       	push   $0x8010c920
...
8010081b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&cons.lock);
8010081e:	68 20 c9 10 80       	push   $0x8010c920
...
8010084f:	75 54                	jne    801008a5 <consoleintr+0x95>
      if(input.e != input.w){
80100851:	a1 a8 23 11 80       	mov    0x801123a8,%eax
80100856:	3b 05 a4 23 11 80    	cmp    0x801123a4,%eax
8010085c:	74 d2                	je     80100830 <consoleintr+0x20>
        input.e--;
8010085e:	83 e8 01             	sub    $0x1,%eax
80100861:	a3 a8 23 11 80       	mov    %eax,0x801123a8
        consputc(BACKSPACE);
...
80100883:	68 20 c9 10 80       	push   $0x8010c920
...
801008a9:	a1 a8 23 11 80       	mov    0x801123a8,%eax
801008ae:	89 c2                	mov    %eax,%edx
801008b0:	2b 15 a0 23 11 80    	sub    0x801123a0,%edx
...
801008c8:	89 15 a8 23 11 80    	mov    %edx,0x801123a8
        c = (c == '\r') ? '\n' : c;
801008ce:	0f 84 cc 00 00 00    	je     801009a0 <consoleintr+0x190>
        input.buf[input.e++ % INPUT_BUF] = c;
801008d4:	89 f9                	mov    %edi,%ecx
801008d6:	88 88 20 23 11 80    	mov    %cl,-0x7feedce0(%eax)
        consputc(c);
...
801008f5:	a1 a0 23 11 80       	mov    0x801123a0,%eax
801008fa:	83 e8 80             	sub    $0xffffff80,%eax
801008fd:	39 05 a8 23 11 80    	cmp    %eax,0x801123a8
80100903:	0f 85 27 ff ff ff    	jne    80100830 <consoleintr+0x20>
          wakeup(&input.r);
80100909:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
8010090c:	a3 a4 23 11 80       	mov    %eax,0x801123a4
          wakeup(&input.r);
80100911:	68 a0 23 11 80       	push   $0x801123a0
...
80100938:	a1 a8 23 11 80       	mov    0x801123a8,%eax
8010093d:	39 05 a4 23 11 80    	cmp    %eax,0x801123a4
80100943:	75 2b                	jne    80100970 <consoleintr+0x160>
80100945:	e9 e6 fe ff ff       	jmp    80100830 <consoleintr+0x20>
8010094a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        input.e--;
80100950:	a3 a8 23 11 80       	mov    %eax,0x801123a8
        consputc(BACKSPACE);
80100955:	b8 00 01 00 00       	mov    $0x100,%eax
8010095a:	e8 b1 fa ff ff       	call   80100410 <consputc>
      while(input.e != input.w &&
8010095f:	a1 a8 23 11 80       	mov    0x801123a8,%eax
80100964:	3b 05 a4 23 11 80    	cmp    0x801123a4,%eax
...
80100975:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100978:	80 ba 20 23 11 80 0a 	cmpb   $0xa,-0x7feedce0(%edx)
...
8010099c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        input.buf[input.e++ % INPUT_BUF] = c;
801009a0:	c6 80 20 23 11 80 0a 	movb   $0xa,-0x7feedce0(%eax)
        consputc(c);
801009a7:	b8 0a 00 00 00       	mov    $0xa,%eax
801009ac:	e8 5f fa ff ff       	call   80100410 <consputc>
801009b1:	a1 a8 23 11 80       	mov    0x801123a8,%eax
...
801009cb:	68 20 c9 10 80       	push   $0x8010c920
...
801009d9:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
801009db:	c7 05 6c 2d 11 80 00 	movl   $0x80100600,0x80112d6c
801009e2:	06 10 80 
  devsw[CONSOLE].read = consoleread;
801009e5:	c7 05 68 2d 11 80 70 	movl   $0x80100270,0x80112d68
801009ec:	02 10 80 
  cons.locking = 1;
801009ef:	c7 05 54 c9 10 80 01 	movl   $0x1,0x8010c954
801009f6:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 e7 6a 00 00       	call   80107580 <setupkvm>
...
80100af6:	e8 a5 68 00 00       	call   801073a0 <allocuvm>
...
80100b28:	e8 b3 67 00 00       	call   801072e0 <loaduvm>
...
80100b72:	e8 89 69 00 00       	call   80107500 <freevm>
...
80100baa:	e8 f1 67 00 00       	call   801073a0 <allocuvm>
...
80100bc1:	e8 3a 69 00 00       	call   80107500 <freevm>
...
80100c06:	e8 15 6a 00 00       	call   80107620 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 0e 6b 00 00       	call   80107770 <copyout>
...
80100cc1:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cc7:	e8 a4 6a 00 00       	call   80107770 <copyout>
...
80100d34:	e8 17 64 00 00       	call   80107150 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 bf 67 00 00       	call   80107500 <freevm>
  return 0;
...
80100d6b:	68 c0 23 11 80       	push   $0x801123c0
...
80100d84:	bb f4 23 11 80       	mov    $0x801123f4,%ebx
{
80100d89:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100d8c:	68 c0 23 11 80       	push   $0x801123c0
...
80100da3:	81 fb 54 2d 11 80    	cmp    $0x80112d54,%ebx
...
80100db5:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100dbc:	68 c0 23 11 80       	push   $0x801123c0
...
80100dd3:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100dd5:	68 c0 23 11 80       	push   $0x801123c0
...
80100df7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100dfa:	68 c0 23 11 80       	push   $0x801123c0
...
80100e14:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e17:	68 c0 23 11 80       	push   $0x801123c0
...
80100e49:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100e4c:	68 c0 23 11 80       	push   $0x801123c0
...
80100e6c:	74 1a                	je     80100e88 <fileclose+0x48>
    release(&ftable.lock);
80100e6e:	c7 45 08 c0 23 11 80 	movl   $0x801123c0,0x8(%ebp)
...
80100e9d:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100ea0:	68 c0 23 11 80       	push   $0x801123c0
  ff = *f;
...
80101119:	8b 0d c0 2d 11 80    	mov    0x80112dc0,%ecx
{
...
8010113c:	03 05 d8 2d 11 80    	add    0x80112dd8,%eax
80101142:	50                   	push   %eax
80101143:	ff 75 d8             	pushl  -0x28(%ebp)
80101146:	e8 85 ef ff ff       	call   801000d0 <bread>
8010114b:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
8010114e:	a1 c0 2d 11 80       	mov    0x80112dc0,%eax
...
801011a9:	39 05 c0 2d 11 80    	cmp    %eax,0x80112dc0
...
8010122a:	bb 14 2e 11 80       	mov    $0x80112e14,%ebx
{
8010122f:	83 ec 28             	sub    $0x28,%esp
80101232:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101235:	68 e0 2d 11 80       	push   $0x80112de0
...
80101256:	81 fb 34 4a 11 80    	cmp    $0x80114a34,%ebx
...
80101278:	81 fb 34 4a 11 80    	cmp    $0x80114a34,%ebx
...
80101293:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
8010129a:	68 e0 2d 11 80       	push   $0x80112de0
...
801012c3:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801012c5:	68 e0 2d 11 80       	push   $0x80112de0
      ip->ref++;
...
8010141c:	68 c0 2d 11 80       	push   $0x80112dc0
...
8010142e:	03 15 d8 2d 11 80    	add    0x80112dd8,%edx
...
80101494:	bb 20 2e 11 80       	mov    $0x80112e20,%ebx
80101499:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010149c:	68 2b 79 10 80       	push   $0x8010792b
801014a1:	68 e0 2d 11 80       	push   $0x80112de0
...
801014c7:	81 fb 40 4a 11 80    	cmp    $0x80114a40,%ebx
801014cd:	75 e1                	jne    801014b0 <iinit+0x20>
  readsb(dev, &sb);
801014cf:	83 ec 08             	sub    $0x8,%esp
801014d2:	68 c0 2d 11 80       	push   $0x80112dc0
801014d7:	ff 75 08             	pushl  0x8(%ebp)
801014da:	e8 f1 fe ff ff       	call   801013d0 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801014df:	ff 35 d8 2d 11 80    	pushl  0x80112dd8
801014e5:	ff 35 d4 2d 11 80    	pushl  0x80112dd4
801014eb:	ff 35 d0 2d 11 80    	pushl  0x80112dd0
801014f1:	ff 35 cc 2d 11 80    	pushl  0x80112dcc
801014f7:	ff 35 c8 2d 11 80    	pushl  0x80112dc8
801014fd:	ff 35 c4 2d 11 80    	pushl  0x80112dc4
80101503:	ff 35 c0 2d 11 80    	pushl  0x80112dc0
...
80101529:	83 3d c8 2d 11 80 01 	cmpl   $0x1,0x80112dc8
{
...
8010155f:	39 1d c8 2d 11 80    	cmp    %ebx,0x80112dc8
80101565:	76 69                	jbe    801015d0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101567:	89 d8                	mov    %ebx,%eax
80101569:	83 ec 08             	sub    $0x8,%esp
8010156c:	c1 e8 03             	shr    $0x3,%eax
8010156f:	03 05 d4 2d 11 80    	add    0x80112dd4,%eax
...
801015f4:	03 05 d4 2d 11 80    	add    0x80112dd4,%eax
...
80101667:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010166a:	68 e0 2d 11 80       	push   $0x80112de0
8010166f:	e8 6c 2c 00 00       	call   801042e0 <acquire>
  ip->ref++;
80101674:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101678:	c7 04 24 e0 2d 11 80 	movl   $0x80112de0,(%esp)
...
801016d9:	03 05 d4 2d 11 80    	add    0x80112dd4,%eax
...
801017ea:	e8 91 29 00 00       	call   80104180 <releasesleep>
  acquire(&icache.lock);
801017ef:	c7 04 24 e0 2d 11 80 	movl   $0x80112de0,(%esp)
801017f6:	e8 e5 2a 00 00       	call   801042e0 <acquire>
  ip->ref--;
801017fb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801017ff:	83 c4 10             	add    $0x10,%esp
80101802:	c7 45 08 e0 2d 11 80 	movl   $0x80112de0,0x8(%ebp)
}
...
8010181b:	68 e0 2d 11 80       	push   $0x80112de0
80101820:	e8 bb 2a 00 00       	call   801042e0 <acquire>
    int r = ip->ref;
80101825:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101828:	c7 04 24 e0 2d 11 80 	movl   $0x80112de0,(%esp)
...
80101a4a:	8b 04 c5 60 2d 11 80 	mov    -0x7feed2a0(,%eax,8),%eax
...
80101b5a:	8b 04 c5 64 2d 11 80 	mov    -0x7feed29c(,%eax,8),%eax
...
80101c91:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101c94:	68 e0 2d 11 80       	push   $0x80112de0
80101c99:	e8 42 26 00 00       	call   801042e0 <acquire>
  ip->ref++;
80101c9e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101ca2:	c7 04 24 e0 2d 11 80 	movl   $0x80112de0,(%esp)
...
80101ed8:	68 86 7f 10 80       	push   $0x80107f86
...
8010201b:	68 80 c9 10 80       	push   $0x8010c980
80102020:	e8 cb 21 00 00       	call   801041f0 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80102025:	58                   	pop    %eax
80102026:	a1 00 51 11 80       	mov    0x80115100,%eax
8010202b:	5a                   	pop    %edx
...
80102068:	74 f6                	je     80102060 <ideinit+0x50>
      havedisk1 = 1;
8010206a:	c7 05 60 c9 10 80 01 	movl   $0x1,0x8010c960
80102071:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102096:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102099:	68 80 c9 10 80       	push   $0x8010c980
8010209e:	e8 3d 22 00 00       	call   801042e0 <acquire>

  if((b = idequeue) == 0){
801020a3:	8b 1d 64 c9 10 80    	mov    0x8010c964,%ebx
...
801020b3:	a3 64 c9 10 80       	mov    %eax,0x8010c964
...
80102101:	e8 3a 1e 00 00       	call   80103f40 <wakeup>
  ...
  if(idequeue != 0)
80102106:	a1 64 c9 10 80       	mov    0x8010c964,%eax
...
8010211a:	68 80 c9 10 80       	push   $0x8010c980
...
80102163:	a1 60 c9 10 80       	mov    0x8010c960,%eax
...
80102173:	68 80 c9 10 80       	push   $0x8010c980
80102178:	e8 63 21 00 00       	call   801042e0 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010217d:	8b 15 64 c9 10 80    	mov    0x8010c964,%edx
...
801021a4:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
801021a6:	39 1d 64 c9 10 80    	cmp    %ebx,0x8010c964
...
801021c3:	68 80 c9 10 80       	push   $0x8010c980
...
801021d9:	75 e5                	jne    801021c0 <iderw+0x90>
  ...
  release(&idelock);
801021db:	c7 45 08 80 c9 10 80 	movl   $0x8010c980,0x8(%ebp)
}
...
801021f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
80102200:	ba 64 c9 10 80       	mov    $0x8010c964,%edx
...
80102231:	c7 05 34 4a 11 80 00 	movl   $0xfec00000,0x80114a34
80102238:	00 c0 fe 
{
...
80102246:	00 00 00 
  return ioapic->data;
80102249:	a1 34 4a 11 80       	mov    0x80114a34,%eax
8010224e:	8b 58 10             	mov    0x10(%eax),%ebx
  ioapic->reg = reg;
80102251:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  return ioapic->data;
80102257:	8b 0d 34 4a 11 80    	mov    0x80114a34,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
8010225d:	0f b6 15 60 4b 11 80 	movzbl 0x80114b60,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
80102281:	8b 0d 34 4a 11 80    	mov    0x80114a34,%ecx
...
801022a0:	89 11                	mov    %edx,(%ecx)
  ioapic->data = data;
801022a2:	8b 0d 34 4a 11 80    	mov    0x80114a34,%ecx
...
801022be:	89 31                	mov    %esi,(%ecx)
  ioapic->data = data;
801022c0:	8b 0d 34 4a 11 80    	mov    0x80114a34,%ecx
...
801022e0:	55                   	push   %ebp
  ioapic->reg = reg;
801022e1:	8b 0d 34 4a 11 80    	mov    0x80114a34,%ecx
{
...
801022f3:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801022f5:	8b 0d 34 4a 11 80    	mov    0x80114a34,%ecx
...
80102304:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102306:	a1 34 4a 11 80       	mov    0x80114a34,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102332:	81 fb a8 78 11 80    	cmp    $0x801178a8,%ebx
...
80102352:	e8 09 21 00 00       	call   80104460 <memset>
  ...
  if(kmem.use_lock)
80102357:	8b 15 74 4a 11 80    	mov    0x80114a74,%edx
...
80102364:	a1 78 4a 11 80       	mov    0x80114a78,%eax
80102369:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010236b:	a1 74 4a 11 80       	mov    0x80114a74,%eax
  kmem.freelist = r;
80102370:	89 1d 78 4a 11 80    	mov    %ebx,0x80114a78
  if(kmem.use_lock)
...
8010237f:	90                   	nop
    release(&kmem.lock);
80102380:	c7 45 08 40 4a 11 80 	movl   $0x80114a40,0x8(%ebp)
}
...
80102393:	68 40 4a 11 80       	push   $0x80114a40
...
80102410:	68 40 4a 11 80       	push   $0x80114a40
...
8010241d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102420:	c7 05 74 4a 11 80 00 	movl   $0x0,0x80114a74
80102427:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
801024b2:	73 e4                	jae    80102498 <kinit2+0x28>
  kmem.use_lock = 1;
801024b4:	c7 05 74 4a 11 80 01 	movl   $0x1,0x80114a74
801024bb:	00 00 00 
}
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
801024d0:	a1 74 4a 11 80       	mov    0x80114a74,%eax
801024d5:	85 c0                	test   %eax,%eax
801024d7:	75 1f                	jne    801024f8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
801024d9:	a1 78 4a 11 80       	mov    0x80114a78,%eax
  if(r)
801024de:	85 c0                	test   %eax,%eax
801024e0:	74 0e                	je     801024f0 <kalloc+0x20>
    kmem.freelist = r->next;
801024e2:	8b 10                	mov    (%eax),%edx
801024e4:	89 15 78 4a 11 80    	mov    %edx,0x80114a78
801024ea:	c3                   	ret    
801024eb:	90                   	nop
...
801024fb:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801024fe:	68 40 4a 11 80       	push   $0x80114a40
80102503:	e8 d8 1d 00 00       	call   801042e0 <acquire>
  r = kmem.freelist;
80102508:	a1 78 4a 11 80       	mov    0x80114a78,%eax
  if(r)
8010250d:	83 c4 10             	add    $0x10,%esp
80102510:	8b 15 74 4a 11 80    	mov    0x80114a74,%edx
80102516:	85 c0                	test   %eax,%eax
80102518:	74 08                	je     80102522 <kalloc+0x52>
    kmem.freelist = r->next;
8010251a:	8b 08                	mov    (%eax),%ecx
8010251c:	89 0d 78 4a 11 80    	mov    %ecx,0x80114a78
  if(kmem.use_lock)
...
8010252c:	68 40 4a 11 80       	push   $0x80114a40
...
80102557:	8b 0d b4 c9 10 80    	mov    0x8010c9b4,%ecx
...
80102595:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
80102597:	89 0d b4 c9 10 80    	mov    %ecx,0x8010c9b4
  c = charcode[shift & (CTL | SHIFT)][data];
...
801025d9:	31 c0                	xor    %eax,%eax
    shift &= ~(shiftcode[data] | E0ESC);
801025db:	89 0d b4 c9 10 80    	mov    %ecx,0x8010c9b4
}
801025e1:	5b                   	pop    %ebx
801025e2:	5d                   	pop    %ebp
801025e3:	c3                   	ret    
...
801025eb:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
801025ed:	89 0d b4 c9 10 80    	mov    %ecx,0x8010c9b4
    return 0;
801025f3:	c3                   	ret    
...
{
  if(!lapic)
80102640:	a1 7c 4a 11 80       	mov    0x80114a7c,%eax
{
...
{
  if (!lapic)
80102740:	8b 15 7c 4a 11 80    	mov    0x80114a7c,%edx
{
...
{
  if(lapic)
80102760:	a1 7c 4a 11 80       	mov    0x80114a7c,%eax
{
...
801027c8:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
801027ce:	a1 7c 4a 11 80       	mov    0x80114a7c,%eax
...
80102a10:	8b 0d c8 4a 11 80    	mov    0x80114ac8,%ecx
...
80102a30:	a1 b4 4a 11 80       	mov    0x80114ab4,%eax
80102a35:	83 ec 08             	sub    $0x8,%esp
80102a38:	01 d8                	add    %ebx,%eax
80102a3a:	83 c0 01             	add    $0x1,%eax
80102a3d:	50                   	push   %eax
80102a3e:	ff 35 c4 4a 11 80    	pushl  0x80114ac4
80102a44:	e8 87 d6 ff ff       	call   801000d0 <bread>
80102a49:	89 c7                	mov    %eax,%edi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102a4b:	58                   	pop    %eax
80102a4c:	5a                   	pop    %edx
80102a4d:	ff 34 9d cc 4a 11 80 	pushl  -0x7feeb534(,%ebx,4)
80102a54:	ff 35 c4 4a 11 80    	pushl  0x80114ac4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102a94:	39 1d c8 4a 11 80    	cmp    %ebx,0x80114ac8
...
80102ab8:	ff 35 b4 4a 11 80    	pushl  0x80114ab4
80102abe:	ff 35 c4 4a 11 80    	pushl  0x80114ac4
80102ac4:	e8 07 d6 ff ff       	call   801000d0 <bread>
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102ac9:	8b 1d c8 4a 11 80    	mov    0x80114ac8,%ebx
...
80102ae0:	8b 8a cc 4a 11 80    	mov    -0x7feeb534(%edx),%ecx
...
80102b1f:	68 80 4a 11 80       	push   $0x80114a80
...
80102b3b:	59                   	pop    %ecx
  log.dev = dev;
80102b3c:	89 1d c4 4a 11 80    	mov    %ebx,0x80114ac4
  log.size = sb.nlog;
80102b42:	89 15 b8 4a 11 80    	mov    %edx,0x80114ab8
  log.start = sb.logstart;
80102b48:	a3 b4 4a 11 80       	mov    %eax,0x80114ab4
  struct buf *buf = bread(log.dev, log.start);
80102b4d:	5a                   	pop    %edx
...
80102b5b:	85 db                	test   %ebx,%ebx
  log.lh.n = lh->n;
80102b5d:	89 1d c8 4a 11 80    	mov    %ebx,0x80114ac8
  for (i = 0; i < log.lh.n; i++) {
...
80102b77:	89 8a c8 4a 11 80    	mov    %ecx,-0x7feeb538(%edx)
  for (i = 0; i < log.lh.n; i++) {
...
80102b8a:	e8 81 fe ff ff       	call   80102a10 <install_trans>
  log.lh.n = 0;
80102b8f:	c7 05 c8 4a 11 80 00 	movl   $0x0,0x80114ac8
80102b96:	00 00 00 
...
80102bb3:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102bb6:	68 80 4a 11 80       	push   $0x80114a80
...
80102bcb:	68 80 4a 11 80       	push   $0x80114a80
80102bd0:	68 80 4a 11 80       	push   $0x80114a80
80102bd5:	e8 b6 11 00 00       	call   80103d90 <sleep>
80102bda:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102bdd:	a1 c0 4a 11 80       	mov    0x80114ac0,%eax
80102be2:	85 c0                	test   %eax,%eax
80102be4:	75 e2                	jne    80102bc8 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102be6:	a1 bc 4a 11 80       	mov    0x80114abc,%eax
80102beb:	8b 15 c8 4a 11 80    	mov    0x80114ac8,%edx
...
80102bff:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102c02:	a3 bc 4a 11 80       	mov    %eax,0x80114abc
      release(&log.lock);
80102c07:	68 80 4a 11 80       	push   $0x80114a80
...
80102c26:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102c29:	68 80 4a 11 80       	push   $0x80114a80
80102c2e:	e8 ad 16 00 00       	call   801042e0 <acquire>
  log.outstanding -= 1;
80102c33:	a1 bc 4a 11 80       	mov    0x80114abc,%eax
  if(log.committing)
80102c38:	8b 35 c0 4a 11 80    	mov    0x80114ac0,%esi
...
80102c44:	85 f6                	test   %esi,%esi
  log.outstanding -= 1;
80102c46:	89 1d bc 4a 11 80    	mov    %ebx,0x80114abc
  if(log.committing)
...
80102c5a:	83 ec 0c             	sub    $0xc,%esp
    log.committing = 1;
80102c5d:	c7 05 c0 4a 11 80 01 	movl   $0x1,0x80114ac0
80102c64:	00 00 00 
  release(&log.lock);
80102c67:	68 80 4a 11 80       	push   $0x80114a80
...
{
  if (log.lh.n > 0) {
80102c71:	8b 0d c8 4a 11 80    	mov    0x80114ac8,%ecx
80102c77:	83 c4 10             	add    $0x10,%esp
80102c7a:	85 c9                	test   %ecx,%ecx
80102c7c:	0f 8e 85 00 00 00    	jle    80102d07 <end_op+0xe7>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
80102c82:	a1 b4 4a 11 80       	mov    0x80114ab4,%eax
80102c87:	83 ec 08             	sub    $0x8,%esp
80102c8a:	01 d8                	add    %ebx,%eax
80102c8c:	83 c0 01             	add    $0x1,%eax
80102c8f:	50                   	push   %eax
80102c90:	ff 35 c4 4a 11 80    	pushl  0x80114ac4
80102c96:	e8 35 d4 ff ff       	call   801000d0 <bread>
80102c9b:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102c9d:	58                   	pop    %eax
80102c9e:	5a                   	pop    %edx
80102c9f:	ff 34 9d cc 4a 11 80 	pushl  -0x7feeb534(,%ebx,4)
80102ca6:	ff 35 c4 4a 11 80    	pushl  0x80114ac4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ce6:	3b 1d c8 4a 11 80    	cmp    0x80114ac8,%ebx
...
80102cf3:	e8 18 fd ff ff       	call   80102a10 <install_trans>
    log.lh.n = 0;
80102cf8:	c7 05 c8 4a 11 80 00 	movl   $0x0,0x80114ac8
80102cff:	00 00 00 
    write_head();    // Erase the transaction from the log
80102d02:	e8 a9 fd ff ff       	call   80102ab0 <write_head>
    acquire(&log.lock);
80102d07:	83 ec 0c             	sub    $0xc,%esp
80102d0a:	68 80 4a 11 80       	push   $0x80114a80
80102d0f:	e8 cc 15 00 00       	call   801042e0 <acquire>
    wakeup(&log);
80102d14:	c7 04 24 80 4a 11 80 	movl   $0x80114a80,(%esp)
    log.committing = 0;
80102d1b:	c7 05 c0 4a 11 80 00 	movl   $0x0,0x80114ac0
80102d22:	00 00 00 
    wakeup(&log);
80102d25:	e8 16 12 00 00       	call   80103f40 <wakeup>
    release(&log.lock);
80102d2a:	c7 04 24 80 4a 11 80 	movl   $0x80114a80,(%esp)
...
80102d4b:	68 80 4a 11 80       	push   $0x80114a80
80102d50:	e8 eb 11 00 00       	call   80103f40 <wakeup>
  release(&log.lock);
80102d55:	c7 04 24 80 4a 11 80 	movl   $0x80114a80,(%esp)
...
80102d87:	8b 15 c8 4a 11 80    	mov    0x80114ac8,%edx
{
80102d8d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102d90:	83 fa 1d             	cmp    $0x1d,%edx
80102d93:	0f 8f 9d 00 00 00    	jg     80102e36 <log_write+0xb6>
80102d99:	a1 b8 4a 11 80       	mov    0x80114ab8,%eax
80102d9e:	83 e8 01             	sub    $0x1,%eax
80102da1:	39 c2                	cmp    %eax,%edx
80102da3:	0f 8d 8d 00 00 00    	jge    80102e36 <log_write+0xb6>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102da9:	a1 bc 4a 11 80       	mov    0x80114abc,%eax
...
80102db9:	68 80 4a 11 80       	push   $0x80114a80
80102dbe:	e8 1d 15 00 00       	call   801042e0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102dc3:	8b 0d c8 4a 11 80    	mov    0x80114ac8,%ecx
...
80102dd4:	31 c0                	xor    %eax,%eax
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102dd6:	3b 15 cc 4a 11 80    	cmp    0x80114acc,%edx
80102ddc:	75 0b                	jne    80102de9 <log_write+0x69>
80102dde:	eb 38                	jmp    80102e18 <log_write+0x98>
80102de0:	39 14 85 cc 4a 11 80 	cmp    %edx,-0x7feeb534(,%eax,4)
...
80102df0:	89 14 85 cc 4a 11 80 	mov    %edx,-0x7feeb534(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
80102df7:	83 c0 01             	add    $0x1,%eax
80102dfa:	a3 c8 4a 11 80       	mov    %eax,0x80114ac8
  b->flags |= B_DIRTY; // prevent eviction
80102dff:	83 0b 04             	orl    $0x4,(%ebx)
  release(&log.lock);
80102e02:	c7 45 08 80 4a 11 80 	movl   $0x80114a80,0x8(%ebp)
}
...
80102e12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102e18:	89 14 85 cc 4a 11 80 	mov    %edx,-0x7feeb534(,%eax,4)
80102e1f:	eb de                	jmp    80102dff <log_write+0x7f>
80102e21:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80102e28:	8b 43 08             	mov    0x8(%ebx),%eax
80102e2b:	a3 cc 4a 11 80       	mov    %eax,0x80114acc
  if (i == log.lh.n)
...
80102e72:	e8 19 29 00 00       	call   80105790 <idtinit>
...
80102e93:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e96:	e8 95 42 00 00       	call   80107130 <switchkvm>
  seginit();
80102e9b:	e8 00 42 00 00       	call   801070a0 <seginit>
  lapicinit();
...
80102ec7:	68 a8 78 11 80       	push   $0x801178a8
80102ecc:	e8 2f f5 ff ff       	call   80102400 <kinit1>
  kvmalloc();      // kernel page table
80102ed1:	e8 2a 47 00 00       	call   80107600 <kvmalloc>
  mpinit();        // detect other processors
80102ed6:	e8 75 01 00 00       	call   80103050 <mpinit>
  lapicinit();     // interrupt controller
80102edb:	e8 60 f7 ff ff       	call   80102640 <lapicinit>
  seginit();       // segment descriptors
80102ee0:	e8 bb 41 00 00       	call   801070a0 <seginit>
  picinit();       // disable pic
...
80102ef4:	e8 c7 2b 00 00       	call   80105ac0 <uartinit>
  pinit();         // process table
80102ef9:	e8 32 08 00 00       	call   80103730 <pinit>
  tvinit();        // trap vectors
80102efe:	e8 0d 28 00 00       	call   80105710 <tvinit>
  binit();         // buffer cache
...
80102f1a:	68 8c c8 10 80       	push   $0x8010c88c
80102f1f:	68 00 70 00 80       	push   $0x80007000
80102f24:	e8 e7 15 00 00       	call   80104510 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102f29:	69 05 00 51 11 80 b0 	imul   $0xb0,0x80115100,%eax
80102f30:	00 00 00 
80102f33:	83 c4 10             	add    $0x10,%esp
80102f36:	05 80 4b 11 80       	add    $0x80114b80,%eax
80102f3b:	3d 80 4b 11 80       	cmp    $0x80114b80,%eax
80102f40:	76 71                	jbe    80102fb3 <main+0x103>
80102f42:	bb 80 4b 11 80       	mov    $0x80114b80,%ebx
...
80102f6d:	c7 05 f4 6f 00 80 00 	movl   $0x10b000,0x80006ff4
80102f74:	b0 10 00 
    *(void**)(code-4) = stack + KSTACKSIZE;
...
80102f98:	74 f6                	je     80102f90 <main+0xe0>
  for(c = cpus; c < cpus+ncpu; c++){
80102f9a:	69 05 00 51 11 80 b0 	imul   $0xb0,0x80115100,%eax
80102fa1:	00 00 00 
80102fa4:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102faa:	05 80 4b 11 80       	add    $0x80114b80,%eax
...
80103127:	a3 7c 4a 11 80       	mov    %eax,0x80114a7c
...
80103195:	8d 76 00             	lea    0x0(%esi),%esi
      if(ncpu < NCPU) {
80103198:	8b 0d 00 51 11 80    	mov    0x80115100,%ecx
...
801031b0:	89 0d 00 51 11 80    	mov    %ecx,0x80115100
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
801031b6:	88 97 80 4b 11 80    	mov    %dl,-0x7feeb480(%edi)
...
801031cc:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
801031cf:	88 15 60 4b 11 80    	mov    %dl,0x80114b60
      continue;
...
80103614:	bb 54 51 11 80       	mov    $0x80115154,%ebx
{
80103619:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010361c:	68 20 51 11 80       	push   $0x80115120
...
80103633:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
...
found:
  p->state = EMBRYO;
  p->pid = nextpid++;
80103642:	a1 04 c0 10 80       	mov    0x8010c004,%eax
...
80103654:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103657:	68 20 51 11 80       	push   $0x80115120
  p->pid = nextpid++;
8010365c:	89 15 04 c0 10 80    	mov    %edx,0x8010c004
  release(&ptable.lock);
...
80103684:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103687:	c7 40 14 ff 56 10 80 	movl   $0x801056ff,0x14(%eax)
  p->context = (struct context*)sp;
...
801036b3:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
801036b5:	68 20 51 11 80       	push   $0x80115120
...
801036e3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801036e6:	68 20 51 11 80       	push   $0x80115120
801036eb:	e8 10 0d 00 00       	call   80104400 <release>

  if (first) {
801036f0:	a1 00 c0 10 80       	mov    0x8010c000,%eax
...
80103700:	83 ec 0c             	sub    $0xc,%esp
    first = 0;
80103703:	c7 05 00 c0 10 80 00 	movl   $0x0,0x8010c000
8010370a:	00 00 00 
    iinit(ROOTDEV);
...
8010373b:	68 20 51 11 80       	push   $0x80115120
...
8010375c:	e8 df ef ff ff       	call   80102740 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103761:	8b 35 00 51 11 80    	mov    0x80115100,%esi
80103767:	85 f6                	test   %esi,%esi
80103769:	7e 42                	jle    801037ad <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010376b:	0f b6 15 80 4b 11 80 	movzbl 0x80114b80,%edx
80103772:	39 d0                	cmp    %edx,%eax
80103774:	74 30                	je     801037a6 <mycpu+0x56>
80103776:	b9 30 4c 11 80       	mov    $0x80114c30,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010379a:	05 80 4b 11 80       	add    $0x80114b80,%eax
}
...
801037db:	2d 80 4b 11 80       	sub    $0x80114b80,%eax
}
801037e0:	c9                   	leave  
  return mycpu()-cpus;
...
8010382c:	89 c3                	mov    %eax,%ebx
  initproc = p;
8010382e:	a3 b8 c9 10 80       	mov    %eax,0x8010c9b8
  if((p->pgdir = setupkvm()) == 0)
80103833:	e8 48 3d 00 00       	call   80107580 <setupkvm>
...
8010384b:	68 60 c8 10 80       	push   $0x8010c860
80103850:	50                   	push   %eax
80103851:	e8 0a 3a 00 00       	call   80107260 <inituvm>
...
801038d6:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
801038d9:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
801038e0:	e8 fb 09 00 00       	call   801042e0 <acquire>
  p->state = RUNNABLE;
801038e5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801038ec:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
...
8010393c:	e8 0f 38 00 00       	call   80107150 <switchuvm>
  return 0;
...
8010395a:	e8 41 3a 00 00       	call   801073a0 <allocuvm>
...
8010397a:	e8 51 3b 00 00       	call   801074d0 <deallocuvm>
...
801039c8:	e8 83 3c 00 00       	call   80107650 <copyuvm>
...
80103a46:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a49:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
80103a50:	e8 8b 08 00 00       	call   801042e0 <acquire>
  np->state = RUNNABLE;
80103a55:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103a5c:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
...
80103ad1:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ad4:	bb 54 51 11 80       	mov    $0x80115154,%ebx
    acquire(&ptable.lock);
80103ad9:	68 20 51 11 80       	push   $0x80115120
...
80103b00:	e8 4b 36 00 00       	call   80107150 <switchuvm>
...
80103b12:	e8 84 0b 00 00       	call   8010469b <swtch>
      switchkvm();
80103b17:	e8 14 36 00 00       	call   80107130 <switchkvm>
      c->proc = 0;
...
80103b2c:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
80103b32:	72 bc                	jb     80103af0 <scheduler+0x40>
    release(&ptable.lock);
80103b34:	83 ec 0c             	sub    $0xc,%esp
80103b37:	68 20 51 11 80       	push   $0x80115120
...
80103b6d:	68 20 51 11 80       	push   $0x80115120
...
80103c29:	e8 72 07 00 00       	call   801043a0 <popcli>
  if(curproc == initproc)
80103c2e:	39 35 b8 c9 10 80    	cmp    %esi,0x8010c9b8
...
80103c74:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103c7b:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
...
80103cb7:	3d 54 70 11 80       	cmp    $0x80117054,%eax
80103cbc:	72 e4                	jb     80103ca2 <exit+0x92>
      p->parent = initproc;
80103cbe:	8b 0d b8 c9 10 80    	mov    0x8010c9b8,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cc4:	ba 54 51 11 80       	mov    $0x80115154,%edx
80103cc9:	eb 10                	jmp    80103cdb <exit+0xcb>
80103ccb:	90                   	nop
80103ccc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103cd0:	83 c2 7c             	add    $0x7c,%edx
80103cd3:	81 fa 54 70 11 80    	cmp    $0x80117054,%edx
...
80103ce7:	75 e7                	jne    80103cd0 <exit+0xc0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103ce9:	b8 54 51 11 80       	mov    $0x80115154,%eax
80103cee:	eb 0a                	jmp    80103cfa <exit+0xea>
80103cf0:	83 c0 7c             	add    $0x7c,%eax
80103cf3:	3d 54 70 11 80       	cmp    $0x80117054,%eax
...
80103d1d:	68 fd 7d 10 80       	push   $0x80107dfd
80103d22:	e8 69 c6 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d27:	83 ec 0c             	sub    $0xc,%esp
80103d2a:	68 f0 7d 10 80       	push   $0x80107df0
...
80103d47:	68 20 51 11 80       	push   $0x80115120
...
80103d6d:	e8 de fd ff ff       	call   80103b50 <sched>
  release(&ptable.lock);
80103d72:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
...
80103dc0:	81 fe 20 51 11 80    	cmp    $0x80115120,%esi
80103dc6:	74 50                	je     80103e18 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103dc8:	83 ec 0c             	sub    $0xc,%esp
80103dcb:	68 20 51 11 80       	push   $0x80115120
...
80103dec:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103df3:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
...
80103e39:	68 0f 7e 10 80       	push   $0x80107e0f
80103e3e:	e8 4d c5 ff ff       	call   80100390 <panic>
    panic("sleep");
80103e43:	83 ec 0c             	sub    $0xc,%esp
80103e46:	68 09 7e 10 80       	push   $0x80107e09
...
80103ea1:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea6:	81 fb 54 70 11 80    	cmp    $0x80117054,%ebx
...
80103ebc:	68 20 51 11 80       	push   $0x80115120
...
80103ee2:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103ee9:	e8 12 36 00 00       	call   80107500 <freevm>
        release(&ptable.lock);
80103eee:	c7 04 24 20 51 11 80 	movl   $0x80115120,(%esp)
        p->pid = 0;
...
80103f29:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103f2e:	68 20 51 11 80       	push   $0x80115120
...
80103f7f:	3d 54 70 11 80       	cmp    $0x80117054,%eax
80103f84:	72 e4                	jb     80103f6a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80103f86:	c7 45 08 20 51 11 80 	movl   $0x80115120,0x8(%ebp)
}
...
80103fe6:	68 20 51 11 80       	push   $0x80115120
...
80104003:	68 20 51 11 80       	push   $0x80115120
...
80104026:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104029:	bb 54 51 11 80       	mov    $0x80115154,%ebx
{
...
8010405e:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104061:	ba 20 7e 10 80       	mov    $0x80107e20,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104066:	77 11                	ja     80104079 <procdump+0x59>
80104068:	8b 14 85 80 7e 10 80 	mov    -0x7fef8180(,%eax,4),%edx
      state = "???";
8010406f:	b8 20 7e 10 80       	mov    $0x80107e20,%eax
...
80104081:	68 24 7e 10 80       	push   $0x80107e24
...
801040bd:	68 61 78 10 80       	push   $0x80107861
...
801040ea:	68 98 7e 10 80       	push   $0x80107e98
...
8010438b:	68 a3 7e 10 80       	push   $0x80107ea3
...
801043e5:	68 ab 7e 10 80       	push   $0x80107eab
801043ea:	e8 a1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043ef:	83 ec 0c             	sub    $0xc,%esp
801043f2:	68 c2 7e 10 80       	push   $0x80107ec2
...
8010441d:	68 c9 7e 10 80       	push   $0x80107ec9
...
8010486c:	8b 14 85 00 7f 10 80 	mov    -0x7fef8100(,%eax,4),%edx
...
80104890:	68 d1 7e 10 80       	push   $0x80107ed1
...
801049e4:	68 7c 7f 10 80       	push   $0x80107f7c
...
801049fc:	68 7b 7f 10 80       	push   $0x80107f7b
...
80104a15:	68 6f 7f 10 80       	push   $0x80107f6f
...
80104a2a:	68 7e 7f 10 80       	push   $0x80107f7e
80104a2f:	e8 5c b9 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104a34:	83 ec 0c             	sub    $0xc,%esp
80104a37:	68 60 7f 10 80       	push   $0x80107f60
...
80104e29:	58                   	pop    %eax
80104e2a:	5a                   	pop    %edx
80104e2b:	68 7c 7f 10 80       	push   $0x80107f7c
...
80104e44:	68 7b 7f 10 80       	push   $0x80107f7b
...
80105580:	68 60 70 11 80       	push   $0x80117060
...
8010558d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105590:	8b 1d a0 78 11 80    	mov    0x801178a0,%ebx
  while(ticks - ticks0 < n){
...
801055a3:	68 60 70 11 80       	push   $0x80117060
801055a8:	68 a0 78 11 80       	push   $0x801178a0
801055ad:	e8 de e7 ff ff       	call   80103d90 <sleep>
  while(ticks - ticks0 < n){
801055b2:	a1 a0 78 11 80       	mov    0x801178a0,%eax
...
801055d0:	68 60 70 11 80       	push   $0x80117060
...
801055f3:	68 60 70 11 80       	push   $0x80117060
...
80105614:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105617:	68 60 70 11 80       	push   $0x80117060
8010561c:	e8 bf ec ff ff       	call   801042e0 <acquire>
  xticks = ticks;
80105621:	8b 1d a0 78 11 80    	mov    0x801178a0,%ebx
  release(&tickslock);
80105627:	c7 04 24 60 70 11 80 	movl   $0x80117060,(%esp)
...
8010568b:	c1 e0 06             	shl    $0x6,%eax
8010568e:	03 45 ec             	add    -0x14(%ebp),%eax
80105691:	88 90 00 00 0a 80    	mov    %dl,-0x7ff60000(%eax)
  return 0;
...
801056bc:	e8 9f f0 ff ff       	call   80104760 <argint>
801056c1:	83 c4 10             	add    $0x10,%esp
801056c4:	85 c0                	test   %eax,%eax
801056c6:	78 18                	js     801056e0 <sys_modeswitch+0x30>
    return -1;
  vgainit(n);
801056c8:	83 ec 0c             	sub    $0xc,%esp
801056cb:	ff 75 f4             	pushl  -0xc(%ebp)
801056ce:	e8 2d 0d 00 00       	call   80106400 <vgainit>
  return 0;
...
801056e8:	06                   	push   %es
  pushl %fs
801056e9:	0f a0                	push   %fs
  pushl %gs
801056eb:	0f a8                	push   %gs
  pushal
801056ed:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801056ee:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801056f2:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801056f4:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801056f6:	54                   	push   %esp
  call trap
801056f7:	e8 c4 00 00 00       	call   801057c0 <trap>
  addl $4, %esp
801056fc:	83 c4 04             	add    $0x4,%esp
...
801056ff:	61                   	popa   
  popl %gs
80105700:	0f a9                	pop    %gs
  popl %fs
80105702:	0f a1                	pop    %fs
  popl %es
80105704:	07                   	pop    %es
  popl %ds
80105705:	1f                   	pop    %ds
...
80105720:	8b 14 85 20 c4 10 80 	mov    -0x7fef3be0(,%eax,4),%edx
80105727:	c7 04 c5 a2 70 11 80 	movl   $0x8e000008,-0x7fee8f5e(,%eax,8)
8010572e:	08 00 00 8e 
80105732:	66 89 14 c5 a0 70 11 	mov    %dx,-0x7fee8f60(,%eax,8)
80105739:	80 
8010573a:	c1 ea 10             	shr    $0x10,%edx
8010573d:	66 89 14 c5 a6 70 11 	mov    %dx,-0x7fee8f5a(,%eax,8)
80105744:	80 
  for(i = 0; i < 256; i++)
...
8010574f:	a1 20 c5 10 80       	mov    0x8010c520,%eax

  initlock(&tickslock, "time");
80105754:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105757:	c7 05 a2 72 11 80 08 	movl   $0xef000008,0x801172a2
8010575e:	00 00 ef 
  initlock(&tickslock, "time");
80105761:	68 c1 7f 10 80       	push   $0x80107fc1
80105766:	68 60 70 11 80       	push   $0x80117060
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010576b:	66 a3 a0 72 11 80    	mov    %ax,0x801172a0
80105771:	c1 e8 10             	shr    $0x10,%eax
80105774:	66 a3 a6 72 11 80    	mov    %ax,0x801172a6
  initlock(&tickslock, "time");
8010577a:	e8 71 ea ff ff       	call   801041f0 <initlock>
}
...
8010579b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010579f:	b8 a0 70 11 80       	mov    $0x801170a0,%eax
...
801057e0:	ff 24 85 68 80 10 80 	jmp    *-0x7fef7f98(,%eax,4)
...
80105845:	68 24 80 10 80       	push   $0x80108024
...
801058dd:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058e0:	e8 6b ef ff ff       	call   80104850 <syscall>
    if(myproc()->killed)
...
80105934:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105938:	e8 e3 cc ff ff       	call   80102620 <kbdintr>
    lapiceoi();
...
80105987:	68 cc 7f 10 80       	push   $0x80107fcc
8010598c:	e8 cf ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105991:	e8 ca cd ff ff       	call   80102760 <lapiceoi>
    break;
...
801059ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
801059b0:	e8 db c6 ff ff       	call   80102090 <ideintr>
...
801059e3:	68 60 70 11 80       	push   $0x80117060
801059e8:	e8 f3 e8 ff ff       	call   801042e0 <acquire>
      wakeup(&ticks);
801059ed:	c7 04 24 a0 78 11 80 	movl   $0x801178a0,(%esp)
      ticks++;
801059f4:	83 05 a0 78 11 80 01 	addl   $0x1,0x801178a0
      wakeup(&ticks);
801059fb:	e8 40 e5 ff ff       	call   80103f40 <wakeup>
      release(&tickslock);
80105a00:	c7 04 24 60 70 11 80 	movl   $0x80117060,(%esp)
80105a07:	e8 f4 e9 ff ff       	call   80104400 <release>
...
80105a25:	68 f0 7f 10 80       	push   $0x80107ff0
80105a2a:	e8 31 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a2f:	83 c4 14             	add    $0x14,%esp
80105a32:	68 c6 7f 10 80       	push   $0x80107fc6
...
{
  if(!uart)
80105a40:	a1 bc c9 10 80       	mov    0x8010c9bc,%eax
{
...
80105a95:	e8 e6 cc ff ff       	call   80102780 <microdelay>
...
80105b17:	74 5a                	je     80105b73 <uartinit+0xb3>
  uart = 1;
80105b19:	c7 05 bc c9 10 80 01 	movl   $0x1,0x8010c9bc
80105b20:	00 00 00 
...
80105b2c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b2f:	bb e8 80 10 80       	mov    $0x801080e8,%ebx
  ioapicenable(IRQ_COM1, 0);
80105b34:	6a 00                	push   $0x0
80105b36:	6a 04                	push   $0x4
80105b38:	e8 a3 c7 ff ff       	call   801022e0 <ioapicenable>
...
80105b58:	74 19                	je     80105b73 <uartinit+0xb3>
  if(!uart)
80105b5a:	8b 15 bc c9 10 80    	mov    0x8010c9bc,%edx
...
80105b80 <uartputc>:
  if(!uart)
80105b80:	8b 15 bc c9 10 80    	mov    0x8010c9bc,%edx
{
...
80105bd0:	55                   	push   %ebp
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105bd1:	b8 63 00 00 00       	mov    $0x63,%eax
80105bd6:	ba c2 03 00 00       	mov    $0x3c2,%edx
80105bdb:	89 e5                	mov    %esp,%ebp
80105bdd:	57                   	push   %edi
80105bde:	56                   	push   %esi
80105bdf:	53                   	push   %ebx
80105be0:	ee                   	out    %al,(%dx)
80105be1:	31 c9                	xor    %ecx,%ecx
80105be3:	be c4 03 00 00       	mov    $0x3c4,%esi
80105be8:	89 c8                	mov    %ecx,%eax
80105bea:	89 f2                	mov    %esi,%edx
80105bec:	ee                   	out    %al,(%dx)
80105bed:	bb c5 03 00 00       	mov    $0x3c5,%ebx
80105bf2:	b8 03 00 00 00       	mov    $0x3,%eax
80105bf7:	89 da                	mov    %ebx,%edx
80105bf9:	ee                   	out    %al,(%dx)
80105bfa:	b8 01 00 00 00       	mov    $0x1,%eax
80105bff:	89 f2                	mov    %esi,%edx
80105c01:	ee                   	out    %al,(%dx)
80105c02:	89 da                	mov    %ebx,%edx
80105c04:	ee                   	out    %al,(%dx)
80105c05:	b8 02 00 00 00       	mov    $0x2,%eax
80105c0a:	89 f2                	mov    %esi,%edx
80105c0c:	ee                   	out    %al,(%dx)
80105c0d:	bf 0f 00 00 00       	mov    $0xf,%edi
80105c12:	89 da                	mov    %ebx,%edx
80105c14:	89 f8                	mov    %edi,%eax
...
80105c24:	b8 04 00 00 00       	mov    $0x4,%eax
80105c29:	89 f2                	mov    %esi,%edx
80105c2b:	ee                   	out    %al,(%dx)
80105c2c:	b8 0e 00 00 00       	mov    $0xe,%eax
80105c31:	89 da                	mov    %ebx,%edx
80105c33:	ee                   	out    %al,(%dx)
80105c34:	be d4 03 00 00       	mov    $0x3d4,%esi
80105c39:	89 c8                	mov    %ecx,%eax
80105c3b:	89 f2                	mov    %esi,%edx
80105c3d:	ee                   	out    %al,(%dx)
80105c3e:	bb d5 03 00 00       	mov    $0x3d5,%ebx
80105c43:	b8 5f 00 00 00       	mov    $0x5f,%eax
80105c48:	89 da                	mov    %ebx,%edx
80105c4a:	ee                   	out    %al,(%dx)
80105c4b:	b8 01 00 00 00       	mov    $0x1,%eax
80105c50:	89 f2                	mov    %esi,%edx
80105c52:	ee                   	out    %al,(%dx)
80105c53:	b8 4f 00 00 00       	mov    $0x4f,%eax
80105c58:	89 da                	mov    %ebx,%edx
80105c5a:	ee                   	out    %al,(%dx)
80105c5b:	b8 02 00 00 00       	mov    $0x2,%eax
80105c60:	89 f2                	mov    %esi,%edx
80105c62:	ee                   	out    %al,(%dx)
80105c63:	b8 50 00 00 00       	mov    $0x50,%eax
80105c68:	89 da                	mov    %ebx,%edx
80105c6a:	ee                   	out    %al,(%dx)
80105c6b:	b8 03 00 00 00       	mov    $0x3,%eax
80105c70:	89 f2                	mov    %esi,%edx
80105c72:	ee                   	out    %al,(%dx)
80105c73:	b8 82 ff ff ff       	mov    $0xffffff82,%eax
80105c78:	89 da                	mov    %ebx,%edx
80105c7a:	ee                   	out    %al,(%dx)
80105c7b:	b8 04 00 00 00       	mov    $0x4,%eax
80105c80:	89 f2                	mov    %esi,%edx
80105c82:	ee                   	out    %al,(%dx)
80105c83:	b8 54 00 00 00       	mov    $0x54,%eax
80105c88:	89 da                	mov    %ebx,%edx
80105c8a:	ee                   	out    %al,(%dx)
80105c8b:	b8 05 00 00 00       	mov    $0x5,%eax
80105c90:	89 f2                	mov    %esi,%edx
80105c92:	ee                   	out    %al,(%dx)
80105c93:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105c98:	89 da                	mov    %ebx,%edx
80105c9a:	ee                   	out    %al,(%dx)
80105c9b:	b8 06 00 00 00       	mov    $0x6,%eax
80105ca0:	89 f2                	mov    %esi,%edx
80105ca2:	ee                   	out    %al,(%dx)
80105ca3:	b8 bf ff ff ff       	mov    $0xffffffbf,%eax
80105ca8:	89 da                	mov    %ebx,%edx
80105caa:	ee                   	out    %al,(%dx)
80105cab:	b8 07 00 00 00       	mov    $0x7,%eax
80105cb0:	89 f2                	mov    %esi,%edx
80105cb2:	ee                   	out    %al,(%dx)
80105cb3:	b8 1f 00 00 00       	mov    $0x1f,%eax
80105cb8:	89 da                	mov    %ebx,%edx
80105cba:	ee                   	out    %al,(%dx)
80105cbb:	b8 08 00 00 00       	mov    $0x8,%eax
80105cc0:	89 f2                	mov    %esi,%edx
80105cc2:	ee                   	out    %al,(%dx)
80105cc3:	89 c8                	mov    %ecx,%eax
80105cc5:	89 da                	mov    %ebx,%edx
80105cc7:	ee                   	out    %al,(%dx)
80105cc8:	b8 09 00 00 00       	mov    $0x9,%eax
80105ccd:	89 f2                	mov    %esi,%edx
80105ccf:	ee                   	out    %al,(%dx)
80105cd0:	b8 41 00 00 00       	mov    $0x41,%eax
80105cd5:	89 da                	mov    %ebx,%edx
80105cd7:	ee                   	out    %al,(%dx)
80105cd8:	b8 0a 00 00 00       	mov    $0xa,%eax
80105cdd:	89 f2                	mov    %esi,%edx
80105cdf:	ee                   	out    %al,(%dx)
80105ce0:	89 c8                	mov    %ecx,%eax
80105ce2:	89 da                	mov    %ebx,%edx
80105ce4:	ee                   	out    %al,(%dx)
80105ce5:	b8 0b 00 00 00       	mov    $0xb,%eax
80105cea:	89 f2                	mov    %esi,%edx
80105cec:	ee                   	out    %al,(%dx)
80105ced:	89 c8                	mov    %ecx,%eax
80105cef:	89 da                	mov    %ebx,%edx
80105cf1:	ee                   	out    %al,(%dx)
80105cf2:	b8 0c 00 00 00       	mov    $0xc,%eax
80105cf7:	89 f2                	mov    %esi,%edx
80105cf9:	ee                   	out    %al,(%dx)
80105cfa:	89 c8                	mov    %ecx,%eax
80105cfc:	89 da                	mov    %ebx,%edx
80105cfe:	ee                   	out    %al,(%dx)
80105cff:	b8 0d 00 00 00       	mov    $0xd,%eax
80105d04:	89 f2                	mov    %esi,%edx
80105d06:	ee                   	out    %al,(%dx)
80105d07:	89 c8                	mov    %ecx,%eax
80105d09:	89 da                	mov    %ebx,%edx
80105d0b:	ee                   	out    %al,(%dx)
80105d0c:	b8 0e 00 00 00       	mov    $0xe,%eax
80105d11:	89 f2                	mov    %esi,%edx
80105d13:	ee                   	out    %al,(%dx)
80105d14:	89 c8                	mov    %ecx,%eax
80105d16:	89 da                	mov    %ebx,%edx
80105d18:	ee                   	out    %al,(%dx)
80105d19:	89 f8                	mov    %edi,%eax
80105d1b:	89 f2                	mov    %esi,%edx
80105d1d:	ee                   	out    %al,(%dx)
80105d1e:	89 c8                	mov    %ecx,%eax
80105d20:	89 da                	mov    %ebx,%edx
80105d22:	ee                   	out    %al,(%dx)
80105d23:	b8 10 00 00 00       	mov    $0x10,%eax
80105d28:	89 f2                	mov    %esi,%edx
80105d2a:	ee                   	out    %al,(%dx)
80105d2b:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
80105d30:	89 da                	mov    %ebx,%edx
80105d32:	ee                   	out    %al,(%dx)
80105d33:	b8 11 00 00 00       	mov    $0x11,%eax
80105d38:	89 f2                	mov    %esi,%edx
80105d3a:	ee                   	out    %al,(%dx)
80105d3b:	b8 0e 00 00 00       	mov    $0xe,%eax
80105d40:	89 da                	mov    %ebx,%edx
80105d42:	ee                   	out    %al,(%dx)
80105d43:	b8 12 00 00 00       	mov    $0x12,%eax
80105d48:	89 f2                	mov    %esi,%edx
80105d4a:	ee                   	out    %al,(%dx)
80105d4b:	b8 8f ff ff ff       	mov    $0xffffff8f,%eax
80105d50:	89 da                	mov    %ebx,%edx
80105d52:	ee                   	out    %al,(%dx)
80105d53:	b8 13 00 00 00       	mov    $0x13,%eax
80105d58:	89 f2                	mov    %esi,%edx
80105d5a:	ee                   	out    %al,(%dx)
80105d5b:	b8 28 00 00 00       	mov    $0x28,%eax
80105d60:	89 da                	mov    %ebx,%edx
80105d62:	ee                   	out    %al,(%dx)
80105d63:	b8 14 00 00 00       	mov    $0x14,%eax
80105d68:	89 f2                	mov    %esi,%edx
80105d6a:	ee                   	out    %al,(%dx)
80105d6b:	b8 40 00 00 00       	mov    $0x40,%eax
80105d70:	89 da                	mov    %ebx,%edx
80105d72:	ee                   	out    %al,(%dx)
80105d73:	b8 15 00 00 00       	mov    $0x15,%eax
80105d78:	89 f2                	mov    %esi,%edx
80105d7a:	ee                   	out    %al,(%dx)
80105d7b:	b8 96 ff ff ff       	mov    $0xffffff96,%eax
80105d80:	89 da                	mov    %ebx,%edx
80105d82:	ee                   	out    %al,(%dx)
80105d83:	b8 16 00 00 00       	mov    $0x16,%eax
80105d88:	89 f2                	mov    %esi,%edx
80105d8a:	ee                   	out    %al,(%dx)
80105d8b:	b8 b9 ff ff ff       	mov    $0xffffffb9,%eax
80105d90:	89 da                	mov    %ebx,%edx
80105d92:	ee                   	out    %al,(%dx)
80105d93:	b8 17 00 00 00       	mov    $0x17,%eax
80105d98:	89 f2                	mov    %esi,%edx
80105d9a:	ee                   	out    %al,(%dx)
80105d9b:	b8 a3 ff ff ff       	mov    $0xffffffa3,%eax
80105da0:	89 da                	mov    %ebx,%edx
80105da2:	ee                   	out    %al,(%dx)
80105da3:	b8 18 00 00 00       	mov    $0x18,%eax
80105da8:	89 f2                	mov    %esi,%edx
80105daa:	ee                   	out    %al,(%dx)
80105dab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105db0:	89 da                	mov    %ebx,%edx
80105db2:	ee                   	out    %al,(%dx)
80105db3:	be ce 03 00 00       	mov    $0x3ce,%esi
80105db8:	89 c8                	mov    %ecx,%eax
80105dba:	89 f2                	mov    %esi,%edx
80105dbc:	ee                   	out    %al,(%dx)
80105dbd:	bb cf 03 00 00       	mov    $0x3cf,%ebx
80105dc2:	89 da                	mov    %ebx,%edx
80105dc4:	ee                   	out    %al,(%dx)
80105dc5:	b8 01 00 00 00       	mov    $0x1,%eax
80105dca:	89 f2                	mov    %esi,%edx
80105dcc:	ee                   	out    %al,(%dx)
80105dcd:	89 c8                	mov    %ecx,%eax
80105dcf:	89 da                	mov    %ebx,%edx
80105dd1:	ee                   	out    %al,(%dx)
80105dd2:	b8 02 00 00 00       	mov    $0x2,%eax
80105dd7:	89 f2                	mov    %esi,%edx
80105dd9:	ee                   	out    %al,(%dx)
80105dda:	89 c8                	mov    %ecx,%eax
80105ddc:	89 da                	mov    %ebx,%edx
80105dde:	ee                   	out    %al,(%dx)
80105ddf:	b8 03 00 00 00       	mov    $0x3,%eax
80105de4:	89 f2                	mov    %esi,%edx
80105de6:	ee                   	out    %al,(%dx)
80105de7:	89 c8                	mov    %ecx,%eax
80105de9:	89 da                	mov    %ebx,%edx
80105deb:	ee                   	out    %al,(%dx)
80105dec:	b8 04 00 00 00       	mov    $0x4,%eax
80105df1:	89 f2                	mov    %esi,%edx
80105df3:	ee                   	out    %al,(%dx)
80105df4:	89 c8                	mov    %ecx,%eax
80105df6:	89 da                	mov    %ebx,%edx
80105df8:	ee                   	out    %al,(%dx)
80105df9:	b8 05 00 00 00       	mov    $0x5,%eax
80105dfe:	89 f2                	mov    %esi,%edx
80105e00:	ee                   	out    %al,(%dx)
80105e01:	b8 40 00 00 00       	mov    $0x40,%eax
80105e06:	89 da                	mov    %ebx,%edx
80105e08:	ee                   	out    %al,(%dx)
80105e09:	b8 06 00 00 00       	mov    $0x6,%eax
80105e0e:	89 f2                	mov    %esi,%edx
80105e10:	ee                   	out    %al,(%dx)
80105e11:	b8 05 00 00 00       	mov    $0x5,%eax
80105e16:	89 da                	mov    %ebx,%edx
80105e18:	ee                   	out    %al,(%dx)
80105e19:	b8 07 00 00 00       	mov    $0x7,%eax
80105e1e:	89 f2                	mov    %esi,%edx
80105e20:	ee                   	out    %al,(%dx)
80105e21:	89 f8                	mov    %edi,%eax
80105e23:	89 da                	mov    %ebx,%edx
80105e25:	ee                   	out    %al,(%dx)
80105e26:	b8 08 00 00 00       	mov    $0x8,%eax
80105e2b:	89 f2                	mov    %esi,%edx
80105e2d:	ee                   	out    %al,(%dx)
80105e2e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e33:	89 da                	mov    %ebx,%edx
80105e35:	ee                   	out    %al,(%dx)
80105e36:	bb c0 03 00 00       	mov    $0x3c0,%ebx
80105e3b:	89 c8                	mov    %ecx,%eax
80105e3d:	89 da                	mov    %ebx,%edx
80105e3f:	ee                   	out    %al,(%dx)
80105e40:	ee                   	out    %al,(%dx)
80105e41:	b8 01 00 00 00       	mov    $0x1,%eax
80105e46:	ee                   	out    %al,(%dx)
80105e47:	ee                   	out    %al,(%dx)
80105e48:	b8 02 00 00 00       	mov    $0x2,%eax
80105e4d:	ee                   	out    %al,(%dx)
80105e4e:	ee                   	out    %al,(%dx)
80105e4f:	b8 03 00 00 00       	mov    $0x3,%eax
80105e54:	ee                   	out    %al,(%dx)
80105e55:	ee                   	out    %al,(%dx)
80105e56:	b8 04 00 00 00       	mov    $0x4,%eax
80105e5b:	ee                   	out    %al,(%dx)
80105e5c:	ee                   	out    %al,(%dx)
80105e5d:	b8 05 00 00 00       	mov    $0x5,%eax
80105e62:	ee                   	out    %al,(%dx)
80105e63:	ee                   	out    %al,(%dx)
80105e64:	b8 06 00 00 00       	mov    $0x6,%eax
80105e69:	ee                   	out    %al,(%dx)
80105e6a:	ee                   	out    %al,(%dx)
80105e6b:	b8 07 00 00 00       	mov    $0x7,%eax
80105e70:	ee                   	out    %al,(%dx)
80105e71:	ee                   	out    %al,(%dx)
80105e72:	b8 08 00 00 00       	mov    $0x8,%eax
80105e77:	ee                   	out    %al,(%dx)
80105e78:	ee                   	out    %al,(%dx)
80105e79:	b8 09 00 00 00       	mov    $0x9,%eax
80105e7e:	ee                   	out    %al,(%dx)
80105e7f:	ee                   	out    %al,(%dx)
80105e80:	b8 0a 00 00 00       	mov    $0xa,%eax
80105e85:	ee                   	out    %al,(%dx)
80105e86:	ee                   	out    %al,(%dx)
80105e87:	b8 0b 00 00 00       	mov    $0xb,%eax
80105e8c:	ee                   	out    %al,(%dx)
80105e8d:	ee                   	out    %al,(%dx)
80105e8e:	b8 0c 00 00 00       	mov    $0xc,%eax
80105e93:	ee                   	out    %al,(%dx)
80105e94:	ee                   	out    %al,(%dx)
80105e95:	b8 0d 00 00 00       	mov    $0xd,%eax
80105e9a:	ee                   	out    %al,(%dx)
80105e9b:	ee                   	out    %al,(%dx)
80105e9c:	b8 0e 00 00 00       	mov    $0xe,%eax
80105ea1:	ee                   	out    %al,(%dx)
80105ea2:	ee                   	out    %al,(%dx)
80105ea3:	89 f8                	mov    %edi,%eax
80105ea5:	ee                   	out    %al,(%dx)
80105ea6:	ee                   	out    %al,(%dx)
80105ea7:	b8 10 00 00 00       	mov    $0x10,%eax
80105eac:	ee                   	out    %al,(%dx)
80105ead:	b8 41 00 00 00       	mov    $0x41,%eax
80105eb2:	ee                   	out    %al,(%dx)
80105eb3:	b8 11 00 00 00       	mov    $0x11,%eax
80105eb8:	ee                   	out    %al,(%dx)
80105eb9:	89 c8                	mov    %ecx,%eax
80105ebb:	ee                   	out    %al,(%dx)
80105ebc:	b8 12 00 00 00       	mov    $0x12,%eax
80105ec1:	ee                   	out    %al,(%dx)
80105ec2:	89 f8                	mov    %edi,%eax
80105ec4:	ee                   	out    %al,(%dx)
80105ec5:	b8 13 00 00 00       	mov    $0x13,%eax
80105eca:	ee                   	out    %al,(%dx)
80105ecb:	89 c8                	mov    %ecx,%eax
80105ecd:	ee                   	out    %al,(%dx)
80105ece:	b8 14 00 00 00       	mov    $0x14,%eax
80105ed3:	ee                   	out    %al,(%dx)
80105ed4:	89 c8                	mov    %ecx,%eax
80105ed6:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105ed7:	ba da 03 00 00       	mov    $0x3da,%edx
80105edc:	ec                   	in     (%dx),%al
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105edd:	b8 20 00 00 00       	mov    $0x20,%eax
80105ee2:	89 da                	mov    %ebx,%edx
80105ee4:	ee                   	out    %al,(%dx)
  ...
  int i, value;
  for(i = 0; i < 256; i++){
80105ee5:	31 db                	xor    %ebx,%ebx
80105ee7:	bf c8 03 00 00       	mov    $0x3c8,%edi
80105eec:	be c9 03 00 00       	mov    $0x3c9,%esi
80105ef1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    value = vga_pal[i];
80105ef8:	8b 0c 9d 20 c0 10 80 	mov    -0x7fef3fe0(,%ebx,4),%ecx
80105eff:	89 d8                	mov    %ebx,%eax
80105f01:	89 fa                	mov    %edi,%edx
80105f03:	ee                   	out    %al,(%dx)
    outb(0x3C8, i);
    outb(0x3C9, (value>>18)&0x3f);
80105f04:	89 c8                	mov    %ecx,%eax
80105f06:	89 f2                	mov    %esi,%edx
80105f08:	c1 f8 12             	sar    $0x12,%eax
80105f0b:	83 e0 3f             	and    $0x3f,%eax
80105f0e:	ee                   	out    %al,(%dx)
    outb(0x3C9, (value>>10)&0x3f);
80105f0f:	89 c8                	mov    %ecx,%eax
80105f11:	c1 f8 0a             	sar    $0xa,%eax
80105f14:	83 e0 3f             	and    $0x3f,%eax
80105f17:	ee                   	out    %al,(%dx)
    outb(0x3C9, (value>>2)&0x3f);
80105f18:	89 c8                	mov    %ecx,%eax
80105f1a:	c1 f8 02             	sar    $0x2,%eax
80105f1d:	83 e0 3f             	and    $0x3f,%eax
80105f20:	ee                   	out    %al,(%dx)
  for(i = 0; i < 256; i++){
80105f21:	83 c3 01             	add    $0x1,%ebx
80105f24:	81 fb 00 01 00 00    	cmp    $0x100,%ebx
80105f2a:	75 cc                	jne    80105ef8 <mode_13H+0x328>
80105f2c:	b8 00 00 0a 80       	mov    $0x800a0000,%eax
...
80105f3b:	83 c0 01             	add    $0x1,%eax
  for (i = 0; i < 320 * 200; i++){
80105f3e:	3d 00 fa 0a 80       	cmp    $0x800afa00,%eax
80105f43:	75 f3                	jne    80105f38 <mode_13H+0x368>
  }
}
80105f45:	5b                   	pop    %ebx
80105f46:	5e                   	pop    %esi
...
80105f51:	b8 67 00 00 00       	mov    $0x67,%eax
80105f56:	ba c2 03 00 00       	mov    $0x3c2,%edx
80105f5b:	89 e5                	mov    %esp,%ebp
80105f5d:	57                   	push   %edi
80105f5e:	56                   	push   %esi
80105f5f:	53                   	push   %ebx
80105f60:	ee                   	out    %al,(%dx)
80105f61:	31 f6                	xor    %esi,%esi
80105f63:	bf c4 03 00 00       	mov    $0x3c4,%edi
80105f68:	89 f0                	mov    %esi,%eax
80105f6a:	89 fa                	mov    %edi,%edx
80105f6c:	ee                   	out    %al,(%dx)
80105f6d:	b8 03 00 00 00       	mov    $0x3,%eax
80105f72:	ba c5 03 00 00       	mov    $0x3c5,%edx
80105f77:	ee                   	out    %al,(%dx)
80105f78:	b8 01 00 00 00       	mov    $0x1,%eax
80105f7d:	89 fa                	mov    %edi,%edx
80105f7f:	ee                   	out    %al,(%dx)
80105f80:	ba c5 03 00 00       	mov    $0x3c5,%edx
80105f85:	89 f0                	mov    %esi,%eax
80105f87:	ee                   	out    %al,(%dx)
80105f88:	b8 02 00 00 00       	mov    $0x2,%eax
80105f8d:	89 fa                	mov    %edi,%edx
80105f8f:	ee                   	out    %al,(%dx)
80105f90:	b8 03 00 00 00       	mov    $0x3,%eax
80105f95:	ba c5 03 00 00       	mov    $0x3c5,%edx
80105f9a:	ee                   	out    %al,(%dx)
80105f9b:	89 fa                	mov    %edi,%edx
80105f9d:	ee                   	out    %al,(%dx)
80105f9e:	ba c5 03 00 00       	mov    $0x3c5,%edx
80105fa3:	89 f0                	mov    %esi,%eax
80105fa5:	ee                   	out    %al,(%dx)
80105fa6:	b8 04 00 00 00       	mov    $0x4,%eax
80105fab:	89 fa                	mov    %edi,%edx
80105fad:	ee                   	out    %al,(%dx)
80105fae:	b8 02 00 00 00       	mov    $0x2,%eax
80105fb3:	ba c5 03 00 00       	mov    $0x3c5,%edx
80105fb8:	ee                   	out    %al,(%dx)
80105fb9:	bb d4 03 00 00       	mov    $0x3d4,%ebx
80105fbe:	89 f0                	mov    %esi,%eax
80105fc0:	89 da                	mov    %ebx,%edx
80105fc2:	ee                   	out    %al,(%dx)
80105fc3:	b9 d5 03 00 00       	mov    $0x3d5,%ecx
80105fc8:	b8 5f 00 00 00       	mov    $0x5f,%eax
80105fcd:	89 ca                	mov    %ecx,%edx
80105fcf:	ee                   	out    %al,(%dx)
80105fd0:	b8 01 00 00 00       	mov    $0x1,%eax
80105fd5:	89 da                	mov    %ebx,%edx
80105fd7:	ee                   	out    %al,(%dx)
80105fd8:	b8 4f 00 00 00       	mov    $0x4f,%eax
80105fdd:	89 ca                	mov    %ecx,%edx
80105fdf:	ee                   	out    %al,(%dx)
80105fe0:	b8 02 00 00 00       	mov    $0x2,%eax
80105fe5:	89 da                	mov    %ebx,%edx
80105fe7:	ee                   	out    %al,(%dx)
80105fe8:	b8 50 00 00 00       	mov    $0x50,%eax
80105fed:	89 ca                	mov    %ecx,%edx
80105fef:	ee                   	out    %al,(%dx)
80105ff0:	b8 03 00 00 00       	mov    $0x3,%eax
80105ff5:	89 da                	mov    %ebx,%edx
80105ff7:	ee                   	out    %al,(%dx)
80105ff8:	b8 82 ff ff ff       	mov    $0xffffff82,%eax
80105ffd:	89 ca                	mov    %ecx,%edx
80105fff:	ee                   	out    %al,(%dx)
80106000:	b8 04 00 00 00       	mov    $0x4,%eax
80106005:	89 da                	mov    %ebx,%edx
80106007:	ee                   	out    %al,(%dx)
80106008:	b8 55 00 00 00       	mov    $0x55,%eax
8010600d:	89 ca                	mov    %ecx,%edx
8010600f:	ee                   	out    %al,(%dx)
80106010:	b8 05 00 00 00       	mov    $0x5,%eax
80106015:	89 da                	mov    %ebx,%edx
80106017:	ee                   	out    %al,(%dx)
80106018:	b8 81 ff ff ff       	mov    $0xffffff81,%eax
8010601d:	89 ca                	mov    %ecx,%edx
8010601f:	ee                   	out    %al,(%dx)
80106020:	b8 06 00 00 00       	mov    $0x6,%eax
80106025:	89 da                	mov    %ebx,%edx
80106027:	ee                   	out    %al,(%dx)
80106028:	b8 bf ff ff ff       	mov    $0xffffffbf,%eax
8010602d:	89 ca                	mov    %ecx,%edx
8010602f:	ee                   	out    %al,(%dx)
80106030:	b8 07 00 00 00       	mov    $0x7,%eax
80106035:	89 da                	mov    %ebx,%edx
80106037:	ee                   	out    %al,(%dx)
80106038:	b8 1f 00 00 00       	mov    $0x1f,%eax
8010603d:	89 ca                	mov    %ecx,%edx
8010603f:	ee                   	out    %al,(%dx)
80106040:	b8 08 00 00 00       	mov    $0x8,%eax
80106045:	89 da                	mov    %ebx,%edx
80106047:	ee                   	out    %al,(%dx)
80106048:	89 f0                	mov    %esi,%eax
8010604a:	89 ca                	mov    %ecx,%edx
8010604c:	ee                   	out    %al,(%dx)
8010604d:	b8 09 00 00 00       	mov    $0x9,%eax
80106052:	89 da                	mov    %ebx,%edx
80106054:	ee                   	out    %al,(%dx)
80106055:	b8 4f 00 00 00       	mov    $0x4f,%eax
8010605a:	89 ca                	mov    %ecx,%edx
8010605c:	ee                   	out    %al,(%dx)
8010605d:	b8 0a 00 00 00       	mov    $0xa,%eax
80106062:	89 da                	mov    %ebx,%edx
80106064:	ee                   	out    %al,(%dx)
80106065:	b8 0d 00 00 00       	mov    $0xd,%eax
8010606a:	89 ca                	mov    %ecx,%edx
8010606c:	ee                   	out    %al,(%dx)
8010606d:	b8 0b 00 00 00       	mov    $0xb,%eax
80106072:	89 da                	mov    %ebx,%edx
80106074:	ee                   	out    %al,(%dx)
80106075:	b8 0e 00 00 00       	mov    $0xe,%eax
8010607a:	89 ca                	mov    %ecx,%edx
8010607c:	ee                   	out    %al,(%dx)
8010607d:	b8 0c 00 00 00       	mov    $0xc,%eax
80106082:	89 da                	mov    %ebx,%edx
80106084:	ee                   	out    %al,(%dx)
80106085:	89 f0                	mov    %esi,%eax
80106087:	89 ca                	mov    %ecx,%edx
80106089:	ee                   	out    %al,(%dx)
8010608a:	b8 0d 00 00 00       	mov    $0xd,%eax
8010608f:	89 da                	mov    %ebx,%edx
80106091:	ee                   	out    %al,(%dx)
80106092:	89 f0                	mov    %esi,%eax
80106094:	89 ca                	mov    %ecx,%edx
80106096:	ee                   	out    %al,(%dx)
80106097:	b8 0e 00 00 00       	mov    $0xe,%eax
8010609c:	89 da                	mov    %ebx,%edx
8010609e:	ee                   	out    %al,(%dx)
8010609f:	89 f0                	mov    %esi,%eax
801060a1:	89 ca                	mov    %ecx,%edx
801060a3:	ee                   	out    %al,(%dx)
801060a4:	b8 0f 00 00 00       	mov    $0xf,%eax
801060a9:	89 da                	mov    %ebx,%edx
801060ab:	ee                   	out    %al,(%dx)
801060ac:	b8 50 00 00 00       	mov    $0x50,%eax
801060b1:	89 ca                	mov    %ecx,%edx
801060b3:	ee                   	out    %al,(%dx)
801060b4:	b8 10 00 00 00       	mov    $0x10,%eax
801060b9:	89 da                	mov    %ebx,%edx
801060bb:	ee                   	out    %al,(%dx)
801060bc:	b8 9c ff ff ff       	mov    $0xffffff9c,%eax
801060c1:	89 ca                	mov    %ecx,%edx
801060c3:	ee                   	out    %al,(%dx)
801060c4:	b8 11 00 00 00       	mov    $0x11,%eax
801060c9:	89 da                	mov    %ebx,%edx
801060cb:	ee                   	out    %al,(%dx)
801060cc:	b8 0e 00 00 00       	mov    $0xe,%eax
801060d1:	89 ca                	mov    %ecx,%edx
801060d3:	ee                   	out    %al,(%dx)
801060d4:	b8 12 00 00 00       	mov    $0x12,%eax
801060d9:	89 da                	mov    %ebx,%edx
801060db:	ee                   	out    %al,(%dx)
801060dc:	b8 8f ff ff ff       	mov    $0xffffff8f,%eax
801060e1:	89 ca                	mov    %ecx,%edx
801060e3:	ee                   	out    %al,(%dx)
801060e4:	b8 13 00 00 00       	mov    $0x13,%eax
801060e9:	89 da                	mov    %ebx,%edx
801060eb:	ee                   	out    %al,(%dx)
801060ec:	b8 28 00 00 00       	mov    $0x28,%eax
801060f1:	89 ca                	mov    %ecx,%edx
801060f3:	ee                   	out    %al,(%dx)
801060f4:	b8 14 00 00 00       	mov    $0x14,%eax
801060f9:	89 da                	mov    %ebx,%edx
801060fb:	ee                   	out    %al,(%dx)
801060fc:	b8 1f 00 00 00       	mov    $0x1f,%eax
80106101:	89 ca                	mov    %ecx,%edx
80106103:	ee                   	out    %al,(%dx)
80106104:	b8 15 00 00 00       	mov    $0x15,%eax
80106109:	89 da                	mov    %ebx,%edx
8010610b:	ee                   	out    %al,(%dx)
8010610c:	b8 96 ff ff ff       	mov    $0xffffff96,%eax
80106111:	89 ca                	mov    %ecx,%edx
80106113:	ee                   	out    %al,(%dx)
80106114:	b8 16 00 00 00       	mov    $0x16,%eax
80106119:	89 da                	mov    %ebx,%edx
8010611b:	ee                   	out    %al,(%dx)
8010611c:	b8 b9 ff ff ff       	mov    $0xffffffb9,%eax
80106121:	89 ca                	mov    %ecx,%edx
80106123:	ee                   	out    %al,(%dx)
80106124:	b8 17 00 00 00       	mov    $0x17,%eax
80106129:	89 da                	mov    %ebx,%edx
8010612b:	ee                   	out    %al,(%dx)
8010612c:	b8 a3 ff ff ff       	mov    $0xffffffa3,%eax
80106131:	89 ca                	mov    %ecx,%edx
80106133:	ee                   	out    %al,(%dx)
80106134:	b8 18 00 00 00       	mov    $0x18,%eax
80106139:	89 da                	mov    %ebx,%edx
8010613b:	ee                   	out    %al,(%dx)
8010613c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106141:	89 ca                	mov    %ecx,%edx
80106143:	ee                   	out    %al,(%dx)
80106144:	bb ce 03 00 00       	mov    $0x3ce,%ebx
80106149:	89 f0                	mov    %esi,%eax
8010614b:	89 da                	mov    %ebx,%edx
8010614d:	ee                   	out    %al,(%dx)
8010614e:	b9 cf 03 00 00       	mov    $0x3cf,%ecx
80106153:	89 ca                	mov    %ecx,%edx
80106155:	ee                   	out    %al,(%dx)
80106156:	b8 01 00 00 00       	mov    $0x1,%eax
8010615b:	89 da                	mov    %ebx,%edx
8010615d:	ee                   	out    %al,(%dx)
8010615e:	89 f0                	mov    %esi,%eax
80106160:	89 ca                	mov    %ecx,%edx
80106162:	ee                   	out    %al,(%dx)
80106163:	b8 02 00 00 00       	mov    $0x2,%eax
80106168:	89 da                	mov    %ebx,%edx
8010616a:	ee                   	out    %al,(%dx)
8010616b:	89 f0                	mov    %esi,%eax
8010616d:	89 ca                	mov    %ecx,%edx
8010616f:	ee                   	out    %al,(%dx)
80106170:	b8 03 00 00 00       	mov    $0x3,%eax
80106175:	89 da                	mov    %ebx,%edx
80106177:	ee                   	out    %al,(%dx)
80106178:	89 f0                	mov    %esi,%eax
8010617a:	89 ca                	mov    %ecx,%edx
8010617c:	ee                   	out    %al,(%dx)
8010617d:	b8 04 00 00 00       	mov    $0x4,%eax
80106182:	89 da                	mov    %ebx,%edx
80106184:	ee                   	out    %al,(%dx)
80106185:	89 f0                	mov    %esi,%eax
80106187:	89 ca                	mov    %ecx,%edx
80106189:	ee                   	out    %al,(%dx)
8010618a:	b8 05 00 00 00       	mov    $0x5,%eax
8010618f:	89 da                	mov    %ebx,%edx
80106191:	ee                   	out    %al,(%dx)
80106192:	b8 10 00 00 00       	mov    $0x10,%eax
80106197:	89 ca                	mov    %ecx,%edx
80106199:	ee                   	out    %al,(%dx)
8010619a:	b8 06 00 00 00       	mov    $0x6,%eax
8010619f:	89 da                	mov    %ebx,%edx
801061a1:	ee                   	out    %al,(%dx)
801061a2:	b8 0e 00 00 00       	mov    $0xe,%eax
801061a7:	89 ca                	mov    %ecx,%edx
801061a9:	ee                   	out    %al,(%dx)
801061aa:	b8 07 00 00 00       	mov    $0x7,%eax
801061af:	89 da                	mov    %ebx,%edx
801061b1:	ee                   	out    %al,(%dx)
801061b2:	89 f0                	mov    %esi,%eax
801061b4:	89 ca                	mov    %ecx,%edx
801061b6:	ee                   	out    %al,(%dx)
801061b7:	b8 08 00 00 00       	mov    $0x8,%eax
801061bc:	89 da                	mov    %ebx,%edx
801061be:	ee                   	out    %al,(%dx)
801061bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061c4:	89 ca                	mov    %ecx,%edx
801061c6:	ee                   	out    %al,(%dx)
801061c7:	ba c0 03 00 00       	mov    $0x3c0,%edx
801061cc:	89 f0                	mov    %esi,%eax
801061ce:	ee                   	out    %al,(%dx)
801061cf:	ee                   	out    %al,(%dx)
801061d0:	b8 01 00 00 00       	mov    $0x1,%eax
801061d5:	ee                   	out    %al,(%dx)
801061d6:	ee                   	out    %al,(%dx)
801061d7:	b8 02 00 00 00       	mov    $0x2,%eax
801061dc:	ee                   	out    %al,(%dx)
801061dd:	ee                   	out    %al,(%dx)
801061de:	b8 03 00 00 00       	mov    $0x3,%eax
801061e3:	ee                   	out    %al,(%dx)
801061e4:	ee                   	out    %al,(%dx)
801061e5:	b8 04 00 00 00       	mov    $0x4,%eax
801061ea:	ee                   	out    %al,(%dx)
801061eb:	ee                   	out    %al,(%dx)
801061ec:	b8 05 00 00 00       	mov    $0x5,%eax
801061f1:	ee                   	out    %al,(%dx)
801061f2:	ee                   	out    %al,(%dx)
801061f3:	b8 06 00 00 00       	mov    $0x6,%eax
801061f8:	ee                   	out    %al,(%dx)
801061f9:	b8 14 00 00 00       	mov    $0x14,%eax
801061fe:	ee                   	out    %al,(%dx)
801061ff:	b8 07 00 00 00       	mov    $0x7,%eax
80106204:	ee                   	out    %al,(%dx)
80106205:	ee                   	out    %al,(%dx)
80106206:	b8 08 00 00 00       	mov    $0x8,%eax
8010620b:	ee                   	out    %al,(%dx)
8010620c:	b8 38 00 00 00       	mov    $0x38,%eax
80106211:	ee                   	out    %al,(%dx)
80106212:	b8 09 00 00 00       	mov    $0x9,%eax
80106217:	ee                   	out    %al,(%dx)
80106218:	b8 39 00 00 00       	mov    $0x39,%eax
8010621d:	ee                   	out    %al,(%dx)
8010621e:	b8 0a 00 00 00       	mov    $0xa,%eax
80106223:	ee                   	out    %al,(%dx)
80106224:	b8 3a 00 00 00       	mov    $0x3a,%eax
80106229:	ee                   	out    %al,(%dx)
8010622a:	b8 0b 00 00 00       	mov    $0xb,%eax
8010622f:	ee                   	out    %al,(%dx)
80106230:	b8 3b 00 00 00       	mov    $0x3b,%eax
80106235:	ee                   	out    %al,(%dx)
80106236:	b8 0c 00 00 00       	mov    $0xc,%eax
8010623b:	ee                   	out    %al,(%dx)
8010623c:	b8 3c 00 00 00       	mov    $0x3c,%eax
80106241:	ee                   	out    %al,(%dx)
80106242:	b8 0d 00 00 00       	mov    $0xd,%eax
80106247:	ee                   	out    %al,(%dx)
80106248:	b8 3d 00 00 00       	mov    $0x3d,%eax
8010624d:	ee                   	out    %al,(%dx)
8010624e:	b8 0e 00 00 00       	mov    $0xe,%eax
80106253:	ee                   	out    %al,(%dx)
80106254:	b8 3e 00 00 00       	mov    $0x3e,%eax
80106259:	ee                   	out    %al,(%dx)
8010625a:	b8 0f 00 00 00       	mov    $0xf,%eax
8010625f:	ee                   	out    %al,(%dx)
80106260:	b8 3f 00 00 00       	mov    $0x3f,%eax
80106265:	ee                   	out    %al,(%dx)
80106266:	b8 10 00 00 00       	mov    $0x10,%eax
8010626b:	ee                   	out    %al,(%dx)
8010626c:	b8 0c 00 00 00       	mov    $0xc,%eax
80106271:	ee                   	out    %al,(%dx)
80106272:	b8 11 00 00 00       	mov    $0x11,%eax
80106277:	ee                   	out    %al,(%dx)
80106278:	89 f0                	mov    %esi,%eax
8010627a:	ee                   	out    %al,(%dx)
8010627b:	b8 12 00 00 00       	mov    $0x12,%eax
80106280:	ee                   	out    %al,(%dx)
80106281:	b8 0f 00 00 00       	mov    $0xf,%eax
80106286:	ee                   	out    %al,(%dx)
80106287:	b8 13 00 00 00       	mov    $0x13,%eax
8010628c:	ee                   	out    %al,(%dx)
8010628d:	b8 08 00 00 00       	mov    $0x8,%eax
80106292:	ee                   	out    %al,(%dx)
80106293:	b8 14 00 00 00       	mov    $0x14,%eax
80106298:	ee                   	out    %al,(%dx)
80106299:	89 f0                	mov    %esi,%eax
8010629b:	ee                   	out    %al,(%dx)
8010629c:	89 fa                	mov    %edi,%edx
8010629e:	ee                   	out    %al,(%dx)
8010629f:	b8 01 00 00 00       	mov    $0x1,%eax
801062a4:	ba c5 03 00 00       	mov    $0x3c5,%edx
801062a9:	ee                   	out    %al,(%dx)
801062aa:	b8 02 00 00 00       	mov    $0x2,%eax
801062af:	89 fa                	mov    %edi,%edx
801062b1:	ee                   	out    %al,(%dx)
801062b2:	b8 04 00 00 00       	mov    $0x4,%eax
801062b7:	ba c5 03 00 00       	mov    $0x3c5,%edx
801062bc:	ee                   	out    %al,(%dx)
801062bd:	89 fa                	mov    %edi,%edx
801062bf:	ee                   	out    %al,(%dx)
801062c0:	b8 07 00 00 00       	mov    $0x7,%eax
801062c5:	ba c5 03 00 00       	mov    $0x3c5,%edx
801062ca:	ee                   	out    %al,(%dx)
801062cb:	89 f0                	mov    %esi,%eax
801062cd:	89 fa                	mov    %edi,%edx
801062cf:	ee                   	out    %al,(%dx)
801062d0:	b8 03 00 00 00       	mov    $0x3,%eax
801062d5:	ba c5 03 00 00       	mov    $0x3c5,%edx
801062da:	ee                   	out    %al,(%dx)
801062db:	b8 04 00 00 00       	mov    $0x4,%eax
801062e0:	89 da                	mov    %ebx,%edx
801062e2:	ee                   	out    %al,(%dx)
801062e3:	b8 02 00 00 00       	mov    $0x2,%eax
801062e8:	89 ca                	mov    %ecx,%edx
801062ea:	ee                   	out    %al,(%dx)
801062eb:	b8 05 00 00 00       	mov    $0x5,%eax
801062f0:	89 da                	mov    %ebx,%edx
801062f2:	ee                   	out    %al,(%dx)
801062f3:	89 f0                	mov    %esi,%eax
801062f5:	89 ca                	mov    %ecx,%edx
801062f7:	ee                   	out    %al,(%dx)
801062f8:	b8 06 00 00 00       	mov    $0x6,%eax
801062fd:	89 da                	mov    %ebx,%edx
801062ff:	ee                   	out    %al,(%dx)
80106300:	89 f0                	mov    %esi,%eax
80106302:	89 ca                	mov    %ecx,%edx
80106304:	ee                   	out    %al,(%dx)
80106305:	31 c9                	xor    %ecx,%ecx
80106307:	be 00 00 0a 80       	mov    $0x800a0000,%esi
8010630c:	31 d2                	xor    %edx,%edx
8010630e:	bf 10 00 00 00       	mov    $0x10,%edi
80106313:	90                   	nop
80106314:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106318:	8d 5e 10             	lea    0x10(%esi),%ebx
8010631b:	89 f0                	mov    %esi,%eax
8010631d:	eb 09                	jmp    80106328 <mode_3H+0x3d8>
8010631f:	90                   	nop
80106320:	0f b6 94 01 00 81 06 	movzbl 0x68100(%ecx,%eax,1),%edx
80106327:	00 
  uchar *VGA = (uchar*) P2V(0xA0000);
...
80106328:	88 10                	mov    %dl,(%eax)
8010632a:	83 c0 01             	add    $0x1,%eax
    for(j = 0; j < 16; j++) {
8010632d:	39 d8                	cmp    %ebx,%eax
8010632f:	75 ef                	jne    80106320 <mode_3H+0x3d0>
80106331:	8d 41 f0             	lea    -0x10(%ecx),%eax
80106334:	83 c6 20             	add    $0x20,%esi
  for(i = 0; i < 4096; i += 16) {
80106337:	3d 00 f0 ff ff       	cmp    $0xfffff000,%eax
8010633c:	74 0f                	je     8010634d <mode_3H+0x3fd>
8010633e:	89 fa                	mov    %edi,%edx
80106340:	29 ca                	sub    %ecx,%edx
80106342:	89 c1                	mov    %eax,%ecx
80106344:	0f b6 92 00 81 10 80 	movzbl -0x7fef7f00(%edx),%edx
8010634b:	eb cb                	jmp    80106318 <mode_3H+0x3c8>
8010634d:	31 c9                	xor    %ecx,%ecx
8010634f:	be c4 03 00 00       	mov    $0x3c4,%esi
80106354:	89 c8                	mov    %ecx,%eax
80106356:	89 f2                	mov    %esi,%edx
80106358:	ee                   	out    %al,(%dx)
80106359:	bb c5 03 00 00       	mov    $0x3c5,%ebx
8010635e:	b8 01 00 00 00       	mov    $0x1,%eax
80106363:	89 da                	mov    %ebx,%edx
80106365:	ee                   	out    %al,(%dx)
80106366:	b8 02 00 00 00       	mov    $0x2,%eax
8010636b:	89 f2                	mov    %esi,%edx
8010636d:	ee                   	out    %al,(%dx)
8010636e:	bf 03 00 00 00       	mov    $0x3,%edi
80106373:	89 da                	mov    %ebx,%edx
80106375:	89 f8                	mov    %edi,%eax
80106377:	ee                   	out    %al,(%dx)
80106378:	89 f2                	mov    %esi,%edx
8010637a:	ee                   	out    %al,(%dx)
8010637b:	89 c8                	mov    %ecx,%eax
8010637d:	89 da                	mov    %ebx,%edx
8010637f:	ee                   	out    %al,(%dx)
80106380:	b8 04 00 00 00       	mov    $0x4,%eax
80106385:	89 f2                	mov    %esi,%edx
80106387:	ee                   	out    %al,(%dx)
80106388:	b8 02 00 00 00       	mov    $0x2,%eax
8010638d:	89 da                	mov    %ebx,%edx
8010638f:	ee                   	out    %al,(%dx)
80106390:	89 c8                	mov    %ecx,%eax
80106392:	89 f2                	mov    %esi,%edx
80106394:	ee                   	out    %al,(%dx)
80106395:	89 f8                	mov    %edi,%eax
80106397:	89 da                	mov    %ebx,%edx
80106399:	ee                   	out    %al,(%dx)
8010639a:	bb ce 03 00 00       	mov    $0x3ce,%ebx
8010639f:	b8 02 00 00 00       	mov    $0x2,%eax
801063a4:	89 da                	mov    %ebx,%edx
801063a6:	ee                   	out    %al,(%dx)
801063a7:	be cf 03 00 00       	mov    $0x3cf,%esi
801063ac:	89 c8                	mov    %ecx,%eax
801063ae:	89 f2                	mov    %esi,%edx
...
801063bb:	b8 04 00 00 00       	mov    $0x4,%eax
801063c0:	89 da                	mov    %ebx,%edx
801063c2:	ee                   	out    %al,(%dx)
801063c3:	89 c8                	mov    %ecx,%eax
801063c5:	89 f2                	mov    %esi,%edx
801063c7:	ee                   	out    %al,(%dx)
801063c8:	b8 05 00 00 00       	mov    $0x5,%eax
801063cd:	89 da                	mov    %ebx,%edx
801063cf:	ee                   	out    %al,(%dx)
801063d0:	b8 10 00 00 00       	mov    $0x10,%eax
801063d5:	89 f2                	mov    %esi,%edx
801063d7:	ee                   	out    %al,(%dx)
801063d8:	b8 06 00 00 00       	mov    $0x6,%eax
801063dd:	89 da                	mov    %ebx,%edx
801063df:	ee                   	out    %al,(%dx)
801063e0:	b8 0e 00 00 00       	mov    $0xe,%eax
801063e5:	89 f2                	mov    %esi,%edx
801063e7:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801063e8:	ba da 03 00 00       	mov    $0x3da,%edx
801063ed:	ec                   	in     (%dx),%al
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801063ee:	b8 20 00 00 00       	mov    $0x20,%eax
801063f3:	ba c0 03 00 00       	mov    $0x3c0,%edx
...
80106408:	75 06                	jne    80106410 <vgainit+0x10>
}
8010640a:	5d                   	pop    %ebp
    mode_3H();
8010640b:	e9 40 fb ff ff       	jmp    80105f50 <mode_3H>
}
80106410:	5d                   	pop    %ebp
    mode_13H();
80106411:	e9 ba f7 ff ff       	jmp    80105bd0 <mode_13H>
...
80106421:	ba 00 8f 0b 80       	mov    $0x800b8f00,%edx
80106426:	b8 41 00 00 00       	mov    $0x41,%eax
{
8010642b:	89 e5                	mov    %esp,%ebp
8010642d:	83 ec 10             	sub    $0x10,%esp
80106430:	8d 4d f1             	lea    -0xf(%ebp),%ecx
  uchar SO2018[] = "Aguante SO2018!";
80106433:	c7 45 f0 41 67 75 61 	movl   $0x61756741,-0x10(%ebp)
8010643a:	c7 45 f4 6e 74 65 20 	movl   $0x2065746e,-0xc(%ebp)
80106441:	c7 45 f8 53 4f 32 30 	movl   $0x30324f53,-0x8(%ebp)
80106448:	c7 45 fc 31 38 21 00 	movl   $0x213831,-0x4(%ebp)
8010644f:	eb 0d                	jmp    8010645e <salute+0x3e>
80106451:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106458:	0f b6 01             	movzbl (%ecx),%eax
8010645b:	83 c1 01             	add    $0x1,%ecx
  int offset;
...
8010645e:	66 05 00 5f          	add    $0x5f00,%ax
80106462:	83 c2 02             	add    $0x2,%edx
80106465:	66 89 42 fe          	mov    %ax,-0x2(%edx)
  for (x = 0; x < len; x++){
80106469:	81 fa 20 8f 0b 80    	cmp    $0x800b8f20,%edx
8010646f:	75 e7                	jne    80106458 <salute+0x38>
  }
}
80106471:	c9                   	leave  
80106472:	c3                   	ret    
...
80106475:	6a 00                	push   $0x0
  jmp alltraps
80106477:	e9 6b f2 ff ff       	jmp    801056e7 <alltraps>
...
8010647c:	6a 00                	push   $0x0
  pushl $1
8010647e:	6a 01                	push   $0x1
  jmp alltraps
80106480:	e9 62 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106485:	6a 00                	push   $0x0
  pushl $2
80106487:	6a 02                	push   $0x2
  jmp alltraps
80106489:	e9 59 f2 ff ff       	jmp    801056e7 <alltraps>
...
8010648e:	6a 00                	push   $0x0
  pushl $3
80106490:	6a 03                	push   $0x3
  jmp alltraps
80106492:	e9 50 f2 ff ff       	jmp    801056e7 <alltraps>
...
80106497:	6a 00                	push   $0x0
  pushl $4
80106499:	6a 04                	push   $0x4
  jmp alltraps
8010649b:	e9 47 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064a0:	6a 00                	push   $0x0
  pushl $5
801064a2:	6a 05                	push   $0x5
  jmp alltraps
801064a4:	e9 3e f2 ff ff       	jmp    801056e7 <alltraps>
...
801064a9:	6a 00                	push   $0x0
  pushl $6
801064ab:	6a 06                	push   $0x6
  jmp alltraps
801064ad:	e9 35 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064b2:	6a 00                	push   $0x0
  pushl $7
801064b4:	6a 07                	push   $0x7
  jmp alltraps
801064b6:	e9 2c f2 ff ff       	jmp    801056e7 <alltraps>

801064bb <vector8>:
.globl vector8
vector8:
  pushl $8
801064bb:	6a 08                	push   $0x8
  jmp alltraps
801064bd:	e9 25 f2 ff ff       	jmp    801056e7 <alltraps>
...
801064c2:	6a 00                	push   $0x0
  pushl $9
801064c4:	6a 09                	push   $0x9
  jmp alltraps
801064c6:	e9 1c f2 ff ff       	jmp    801056e7 <alltraps>

801064cb <vector10>:
.globl vector10
vector10:
  pushl $10
801064cb:	6a 0a                	push   $0xa
  jmp alltraps
801064cd:	e9 15 f2 ff ff       	jmp    801056e7 <alltraps>

801064d2 <vector11>:
.globl vector11
vector11:
  pushl $11
801064d2:	6a 0b                	push   $0xb
  jmp alltraps
801064d4:	e9 0e f2 ff ff       	jmp    801056e7 <alltraps>

801064d9 <vector12>:
.globl vector12
vector12:
  pushl $12
801064d9:	6a 0c                	push   $0xc
  jmp alltraps
801064db:	e9 07 f2 ff ff       	jmp    801056e7 <alltraps>

801064e0 <vector13>:
.globl vector13
vector13:
  pushl $13
801064e0:	6a 0d                	push   $0xd
  jmp alltraps
801064e2:	e9 00 f2 ff ff       	jmp    801056e7 <alltraps>

801064e7 <vector14>:
.globl vector14
vector14:
  pushl $14
801064e7:	6a 0e                	push   $0xe
  jmp alltraps
801064e9:	e9 f9 f1 ff ff       	jmp    801056e7 <alltraps>
...
801064ee:	6a 00                	push   $0x0
  pushl $15
801064f0:	6a 0f                	push   $0xf
  jmp alltraps
801064f2:	e9 f0 f1 ff ff       	jmp    801056e7 <alltraps>
...
801064f7:	6a 00                	push   $0x0
  pushl $16
801064f9:	6a 10                	push   $0x10
  jmp alltraps
801064fb:	e9 e7 f1 ff ff       	jmp    801056e7 <alltraps>

80106500 <vector17>:
.globl vector17
vector17:
  pushl $17
80106500:	6a 11                	push   $0x11
  jmp alltraps
80106502:	e9 e0 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106507:	6a 00                	push   $0x0
  pushl $18
80106509:	6a 12                	push   $0x12
  jmp alltraps
8010650b:	e9 d7 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106510:	6a 00                	push   $0x0
  pushl $19
80106512:	6a 13                	push   $0x13
  jmp alltraps
80106514:	e9 ce f1 ff ff       	jmp    801056e7 <alltraps>
...
80106519:	6a 00                	push   $0x0
  pushl $20
8010651b:	6a 14                	push   $0x14
  jmp alltraps
8010651d:	e9 c5 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106522:	6a 00                	push   $0x0
  pushl $21
80106524:	6a 15                	push   $0x15
  jmp alltraps
80106526:	e9 bc f1 ff ff       	jmp    801056e7 <alltraps>
...
8010652b:	6a 00                	push   $0x0
  pushl $22
8010652d:	6a 16                	push   $0x16
  jmp alltraps
8010652f:	e9 b3 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106534:	6a 00                	push   $0x0
  pushl $23
80106536:	6a 17                	push   $0x17
  jmp alltraps
80106538:	e9 aa f1 ff ff       	jmp    801056e7 <alltraps>
...
8010653d:	6a 00                	push   $0x0
  pushl $24
8010653f:	6a 18                	push   $0x18
  jmp alltraps
80106541:	e9 a1 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106546:	6a 00                	push   $0x0
  pushl $25
80106548:	6a 19                	push   $0x19
  jmp alltraps
8010654a:	e9 98 f1 ff ff       	jmp    801056e7 <alltraps>
...
8010654f:	6a 00                	push   $0x0
  pushl $26
80106551:	6a 1a                	push   $0x1a
  jmp alltraps
80106553:	e9 8f f1 ff ff       	jmp    801056e7 <alltraps>
...
80106558:	6a 00                	push   $0x0
  pushl $27
8010655a:	6a 1b                	push   $0x1b
  jmp alltraps
8010655c:	e9 86 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106561:	6a 00                	push   $0x0
  pushl $28
80106563:	6a 1c                	push   $0x1c
  jmp alltraps
80106565:	e9 7d f1 ff ff       	jmp    801056e7 <alltraps>
...
8010656a:	6a 00                	push   $0x0
  pushl $29
8010656c:	6a 1d                	push   $0x1d
  jmp alltraps
8010656e:	e9 74 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106573:	6a 00                	push   $0x0
  pushl $30
80106575:	6a 1e                	push   $0x1e
  jmp alltraps
80106577:	e9 6b f1 ff ff       	jmp    801056e7 <alltraps>
...
8010657c:	6a 00                	push   $0x0
  pushl $31
8010657e:	6a 1f                	push   $0x1f
  jmp alltraps
80106580:	e9 62 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106585:	6a 00                	push   $0x0
  pushl $32
80106587:	6a 20                	push   $0x20
  jmp alltraps
80106589:	e9 59 f1 ff ff       	jmp    801056e7 <alltraps>
...
8010658e:	6a 00                	push   $0x0
  pushl $33
80106590:	6a 21                	push   $0x21
  jmp alltraps
80106592:	e9 50 f1 ff ff       	jmp    801056e7 <alltraps>
...
80106597:	6a 00                	push   $0x0
  pushl $34
80106599:	6a 22                	push   $0x22
  jmp alltraps
8010659b:	e9 47 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065a0:	6a 00                	push   $0x0
  pushl $35
801065a2:	6a 23                	push   $0x23
  jmp alltraps
801065a4:	e9 3e f1 ff ff       	jmp    801056e7 <alltraps>
...
801065a9:	6a 00                	push   $0x0
  pushl $36
801065ab:	6a 24                	push   $0x24
  jmp alltraps
801065ad:	e9 35 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065b2:	6a 00                	push   $0x0
  pushl $37
801065b4:	6a 25                	push   $0x25
  jmp alltraps
801065b6:	e9 2c f1 ff ff       	jmp    801056e7 <alltraps>
...
801065bb:	6a 00                	push   $0x0
  pushl $38
801065bd:	6a 26                	push   $0x26
  jmp alltraps
801065bf:	e9 23 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065c4:	6a 00                	push   $0x0
  pushl $39
801065c6:	6a 27                	push   $0x27
  jmp alltraps
801065c8:	e9 1a f1 ff ff       	jmp    801056e7 <alltraps>
...
801065cd:	6a 00                	push   $0x0
  pushl $40
801065cf:	6a 28                	push   $0x28
  jmp alltraps
801065d1:	e9 11 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065d6:	6a 00                	push   $0x0
  pushl $41
801065d8:	6a 29                	push   $0x29
  jmp alltraps
801065da:	e9 08 f1 ff ff       	jmp    801056e7 <alltraps>
...
801065df:	6a 00                	push   $0x0
  pushl $42
801065e1:	6a 2a                	push   $0x2a
  jmp alltraps
801065e3:	e9 ff f0 ff ff       	jmp    801056e7 <alltraps>
...
801065e8:	6a 00                	push   $0x0
  pushl $43
801065ea:	6a 2b                	push   $0x2b
  jmp alltraps
801065ec:	e9 f6 f0 ff ff       	jmp    801056e7 <alltraps>
...
801065f1:	6a 00                	push   $0x0
  pushl $44
801065f3:	6a 2c                	push   $0x2c
  jmp alltraps
801065f5:	e9 ed f0 ff ff       	jmp    801056e7 <alltraps>
...
801065fa:	6a 00                	push   $0x0
  pushl $45
801065fc:	6a 2d                	push   $0x2d
  jmp alltraps
801065fe:	e9 e4 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106603:	6a 00                	push   $0x0
  pushl $46
80106605:	6a 2e                	push   $0x2e
  jmp alltraps
80106607:	e9 db f0 ff ff       	jmp    801056e7 <alltraps>
...
8010660c:	6a 00                	push   $0x0
  pushl $47
8010660e:	6a 2f                	push   $0x2f
  jmp alltraps
80106610:	e9 d2 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106615:	6a 00                	push   $0x0
  pushl $48
80106617:	6a 30                	push   $0x30
  jmp alltraps
80106619:	e9 c9 f0 ff ff       	jmp    801056e7 <alltraps>
...
8010661e:	6a 00                	push   $0x0
  pushl $49
80106620:	6a 31                	push   $0x31
  jmp alltraps
80106622:	e9 c0 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106627:	6a 00                	push   $0x0
  pushl $50
80106629:	6a 32                	push   $0x32
  jmp alltraps
8010662b:	e9 b7 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106630:	6a 00                	push   $0x0
  pushl $51
80106632:	6a 33                	push   $0x33
  jmp alltraps
80106634:	e9 ae f0 ff ff       	jmp    801056e7 <alltraps>
...
80106639:	6a 00                	push   $0x0
  pushl $52
8010663b:	6a 34                	push   $0x34
  jmp alltraps
8010663d:	e9 a5 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106642:	6a 00                	push   $0x0
  pushl $53
80106644:	6a 35                	push   $0x35
  jmp alltraps
80106646:	e9 9c f0 ff ff       	jmp    801056e7 <alltraps>
...
8010664b:	6a 00                	push   $0x0
  pushl $54
8010664d:	6a 36                	push   $0x36
  jmp alltraps
8010664f:	e9 93 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106654:	6a 00                	push   $0x0
  pushl $55
80106656:	6a 37                	push   $0x37
  jmp alltraps
80106658:	e9 8a f0 ff ff       	jmp    801056e7 <alltraps>
...
8010665d:	6a 00                	push   $0x0
  pushl $56
8010665f:	6a 38                	push   $0x38
  jmp alltraps
80106661:	e9 81 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106666:	6a 00                	push   $0x0
  pushl $57
80106668:	6a 39                	push   $0x39
  jmp alltraps
8010666a:	e9 78 f0 ff ff       	jmp    801056e7 <alltraps>
...
8010666f:	6a 00                	push   $0x0
  pushl $58
80106671:	6a 3a                	push   $0x3a
  jmp alltraps
80106673:	e9 6f f0 ff ff       	jmp    801056e7 <alltraps>
...
80106678:	6a 00                	push   $0x0
  pushl $59
8010667a:	6a 3b                	push   $0x3b
  jmp alltraps
8010667c:	e9 66 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106681:	6a 00                	push   $0x0
  pushl $60
80106683:	6a 3c                	push   $0x3c
  jmp alltraps
80106685:	e9 5d f0 ff ff       	jmp    801056e7 <alltraps>
...
8010668a:	6a 00                	push   $0x0
  pushl $61
8010668c:	6a 3d                	push   $0x3d
  jmp alltraps
8010668e:	e9 54 f0 ff ff       	jmp    801056e7 <alltraps>
...
80106693:	6a 00                	push   $0x0
  pushl $62
80106695:	6a 3e                	push   $0x3e
  jmp alltraps
80106697:	e9 4b f0 ff ff       	jmp    801056e7 <alltraps>
...
8010669c:	6a 00                	push   $0x0
  pushl $63
8010669e:	6a 3f                	push   $0x3f
  jmp alltraps
801066a0:	e9 42 f0 ff ff       	jmp    801056e7 <alltraps>
...
801066a5:	6a 00                	push   $0x0
  pushl $64
801066a7:	6a 40                	push   $0x40
  jmp alltraps
801066a9:	e9 39 f0 ff ff       	jmp    801056e7 <alltraps>
...
801066ae:	6a 00                	push   $0x0
  pushl $65
801066b0:	6a 41                	push   $0x41
  jmp alltraps
801066b2:	e9 30 f0 ff ff       	jmp    801056e7 <alltraps>
...
801066b7:	6a 00                	push   $0x0
  pushl $66
801066b9:	6a 42                	push   $0x42
  jmp alltraps
801066bb:	e9 27 f0 ff ff       	jmp    801056e7 <alltraps>
...
801066c0:	6a 00                	push   $0x0
  pushl $67
801066c2:	6a 43                	push   $0x43
  jmp alltraps
801066c4:	e9 1e f0 ff ff       	jmp    801056e7 <alltraps>
...
801066c9:	6a 00                	push   $0x0
  pushl $68
801066cb:	6a 44                	push   $0x44
  jmp alltraps
801066cd:	e9 15 f0 ff ff       	jmp    801056e7 <alltraps>
...
801066d2:	6a 00                	push   $0x0
  pushl $69
801066d4:	6a 45                	push   $0x45
  jmp alltraps
801066d6:	e9 0c f0 ff ff       	jmp    801056e7 <alltraps>
...
801066db:	6a 00                	push   $0x0
  pushl $70
801066dd:	6a 46                	push   $0x46
  jmp alltraps
801066df:	e9 03 f0 ff ff       	jmp    801056e7 <alltraps>
...
801066e4:	6a 00                	push   $0x0
  pushl $71
801066e6:	6a 47                	push   $0x47
  jmp alltraps
801066e8:	e9 fa ef ff ff       	jmp    801056e7 <alltraps>
...
801066ed:	6a 00                	push   $0x0
  pushl $72
801066ef:	6a 48                	push   $0x48
  jmp alltraps
801066f1:	e9 f1 ef ff ff       	jmp    801056e7 <alltraps>
...
801066f6:	6a 00                	push   $0x0
  pushl $73
801066f8:	6a 49                	push   $0x49
  jmp alltraps
801066fa:	e9 e8 ef ff ff       	jmp    801056e7 <alltraps>
...
801066ff:	6a 00                	push   $0x0
  pushl $74
80106701:	6a 4a                	push   $0x4a
  jmp alltraps
80106703:	e9 df ef ff ff       	jmp    801056e7 <alltraps>
...
80106708:	6a 00                	push   $0x0
  pushl $75
8010670a:	6a 4b                	push   $0x4b
  jmp alltraps
8010670c:	e9 d6 ef ff ff       	jmp    801056e7 <alltraps>
...
80106711:	6a 00                	push   $0x0
  pushl $76
80106713:	6a 4c                	push   $0x4c
  jmp alltraps
80106715:	e9 cd ef ff ff       	jmp    801056e7 <alltraps>
...
8010671a:	6a 00                	push   $0x0
  pushl $77
8010671c:	6a 4d                	push   $0x4d
  jmp alltraps
8010671e:	e9 c4 ef ff ff       	jmp    801056e7 <alltraps>
...
80106723:	6a 00                	push   $0x0
  pushl $78
80106725:	6a 4e                	push   $0x4e
  jmp alltraps
80106727:	e9 bb ef ff ff       	jmp    801056e7 <alltraps>
...
8010672c:	6a 00                	push   $0x0
  pushl $79
8010672e:	6a 4f                	push   $0x4f
  jmp alltraps
80106730:	e9 b2 ef ff ff       	jmp    801056e7 <alltraps>
...
80106735:	6a 00                	push   $0x0
  pushl $80
80106737:	6a 50                	push   $0x50
  jmp alltraps
80106739:	e9 a9 ef ff ff       	jmp    801056e7 <alltraps>
...
8010673e:	6a 00                	push   $0x0
  pushl $81
80106740:	6a 51                	push   $0x51
  jmp alltraps
80106742:	e9 a0 ef ff ff       	jmp    801056e7 <alltraps>
...
80106747:	6a 00                	push   $0x0
  pushl $82
80106749:	6a 52                	push   $0x52
  jmp alltraps
8010674b:	e9 97 ef ff ff       	jmp    801056e7 <alltraps>
...
80106750:	6a 00                	push   $0x0
  pushl $83
80106752:	6a 53                	push   $0x53
  jmp alltraps
80106754:	e9 8e ef ff ff       	jmp    801056e7 <alltraps>
...
80106759:	6a 00                	push   $0x0
  pushl $84
8010675b:	6a 54                	push   $0x54
  jmp alltraps
8010675d:	e9 85 ef ff ff       	jmp    801056e7 <alltraps>
...
80106762:	6a 00                	push   $0x0
  pushl $85
80106764:	6a 55                	push   $0x55
  jmp alltraps
80106766:	e9 7c ef ff ff       	jmp    801056e7 <alltraps>
...
8010676b:	6a 00                	push   $0x0
  pushl $86
8010676d:	6a 56                	push   $0x56
  jmp alltraps
8010676f:	e9 73 ef ff ff       	jmp    801056e7 <alltraps>
...
80106774:	6a 00                	push   $0x0
  pushl $87
80106776:	6a 57                	push   $0x57
  jmp alltraps
80106778:	e9 6a ef ff ff       	jmp    801056e7 <alltraps>
...
8010677d:	6a 00                	push   $0x0
  pushl $88
8010677f:	6a 58                	push   $0x58
  jmp alltraps
80106781:	e9 61 ef ff ff       	jmp    801056e7 <alltraps>
...
80106786:	6a 00                	push   $0x0
  pushl $89
80106788:	6a 59                	push   $0x59
  jmp alltraps
8010678a:	e9 58 ef ff ff       	jmp    801056e7 <alltraps>
...
8010678f:	6a 00                	push   $0x0
  pushl $90
80106791:	6a 5a                	push   $0x5a
  jmp alltraps
80106793:	e9 4f ef ff ff       	jmp    801056e7 <alltraps>
...
80106798:	6a 00                	push   $0x0
  pushl $91
8010679a:	6a 5b                	push   $0x5b
  jmp alltraps
8010679c:	e9 46 ef ff ff       	jmp    801056e7 <alltraps>
...
801067a1:	6a 00                	push   $0x0
  pushl $92
801067a3:	6a 5c                	push   $0x5c
  jmp alltraps
801067a5:	e9 3d ef ff ff       	jmp    801056e7 <alltraps>
...
801067aa:	6a 00                	push   $0x0
  pushl $93
801067ac:	6a 5d                	push   $0x5d
  jmp alltraps
801067ae:	e9 34 ef ff ff       	jmp    801056e7 <alltraps>
...
801067b3:	6a 00                	push   $0x0
  pushl $94
801067b5:	6a 5e                	push   $0x5e
  jmp alltraps
801067b7:	e9 2b ef ff ff       	jmp    801056e7 <alltraps>
...
801067bc:	6a 00                	push   $0x0
  pushl $95
801067be:	6a 5f                	push   $0x5f
  jmp alltraps
801067c0:	e9 22 ef ff ff       	jmp    801056e7 <alltraps>
...
801067c5:	6a 00                	push   $0x0
  pushl $96
801067c7:	6a 60                	push   $0x60
  jmp alltraps
801067c9:	e9 19 ef ff ff       	jmp    801056e7 <alltraps>
...
801067ce:	6a 00                	push   $0x0
  pushl $97
801067d0:	6a 61                	push   $0x61
  jmp alltraps
801067d2:	e9 10 ef ff ff       	jmp    801056e7 <alltraps>
...
801067d7:	6a 00                	push   $0x0
  pushl $98
801067d9:	6a 62                	push   $0x62
  jmp alltraps
801067db:	e9 07 ef ff ff       	jmp    801056e7 <alltraps>
...
801067e0:	6a 00                	push   $0x0
  pushl $99
801067e2:	6a 63                	push   $0x63
  jmp alltraps
801067e4:	e9 fe ee ff ff       	jmp    801056e7 <alltraps>
...
801067e9:	6a 00                	push   $0x0
  pushl $100
801067eb:	6a 64                	push   $0x64
  jmp alltraps
801067ed:	e9 f5 ee ff ff       	jmp    801056e7 <alltraps>
...
801067f2:	6a 00                	push   $0x0
  pushl $101
801067f4:	6a 65                	push   $0x65
  jmp alltraps
801067f6:	e9 ec ee ff ff       	jmp    801056e7 <alltraps>
...
801067fb:	6a 00                	push   $0x0
  pushl $102
801067fd:	6a 66                	push   $0x66
  jmp alltraps
801067ff:	e9 e3 ee ff ff       	jmp    801056e7 <alltraps>
...
80106804:	6a 00                	push   $0x0
  pushl $103
80106806:	6a 67                	push   $0x67
  jmp alltraps
80106808:	e9 da ee ff ff       	jmp    801056e7 <alltraps>
...
8010680d:	6a 00                	push   $0x0
  pushl $104
8010680f:	6a 68                	push   $0x68
  jmp alltraps
80106811:	e9 d1 ee ff ff       	jmp    801056e7 <alltraps>
...
80106816:	6a 00                	push   $0x0
  pushl $105
80106818:	6a 69                	push   $0x69
  jmp alltraps
8010681a:	e9 c8 ee ff ff       	jmp    801056e7 <alltraps>
...
8010681f:	6a 00                	push   $0x0
  pushl $106
80106821:	6a 6a                	push   $0x6a
  jmp alltraps
80106823:	e9 bf ee ff ff       	jmp    801056e7 <alltraps>
...
80106828:	6a 00                	push   $0x0
  pushl $107
8010682a:	6a 6b                	push   $0x6b
  jmp alltraps
8010682c:	e9 b6 ee ff ff       	jmp    801056e7 <alltraps>
...
80106831:	6a 00                	push   $0x0
  pushl $108
80106833:	6a 6c                	push   $0x6c
  jmp alltraps
80106835:	e9 ad ee ff ff       	jmp    801056e7 <alltraps>
...
8010683a:	6a 00                	push   $0x0
  pushl $109
8010683c:	6a 6d                	push   $0x6d
  jmp alltraps
8010683e:	e9 a4 ee ff ff       	jmp    801056e7 <alltraps>
...
80106843:	6a 00                	push   $0x0
  pushl $110
80106845:	6a 6e                	push   $0x6e
  jmp alltraps
80106847:	e9 9b ee ff ff       	jmp    801056e7 <alltraps>
...
8010684c:	6a 00                	push   $0x0
  pushl $111
8010684e:	6a 6f                	push   $0x6f
  jmp alltraps
80106850:	e9 92 ee ff ff       	jmp    801056e7 <alltraps>
...
80106855:	6a 00                	push   $0x0
  pushl $112
80106857:	6a 70                	push   $0x70
  jmp alltraps
80106859:	e9 89 ee ff ff       	jmp    801056e7 <alltraps>
...
8010685e:	6a 00                	push   $0x0
  pushl $113
80106860:	6a 71                	push   $0x71
  jmp alltraps
80106862:	e9 80 ee ff ff       	jmp    801056e7 <alltraps>
...
80106867:	6a 00                	push   $0x0
  pushl $114
80106869:	6a 72                	push   $0x72
  jmp alltraps
8010686b:	e9 77 ee ff ff       	jmp    801056e7 <alltraps>
...
80106870:	6a 00                	push   $0x0
  pushl $115
80106872:	6a 73                	push   $0x73
  jmp alltraps
80106874:	e9 6e ee ff ff       	jmp    801056e7 <alltraps>
...
80106879:	6a 00                	push   $0x0
  pushl $116
8010687b:	6a 74                	push   $0x74
  jmp alltraps
8010687d:	e9 65 ee ff ff       	jmp    801056e7 <alltraps>
...
80106882:	6a 00                	push   $0x0
  pushl $117
80106884:	6a 75                	push   $0x75
  jmp alltraps
80106886:	e9 5c ee ff ff       	jmp    801056e7 <alltraps>
...
8010688b:	6a 00                	push   $0x0
  pushl $118
8010688d:	6a 76                	push   $0x76
  jmp alltraps
8010688f:	e9 53 ee ff ff       	jmp    801056e7 <alltraps>
...
80106894:	6a 00                	push   $0x0
  pushl $119
80106896:	6a 77                	push   $0x77
  jmp alltraps
80106898:	e9 4a ee ff ff       	jmp    801056e7 <alltraps>
...
8010689d:	6a 00                	push   $0x0
  pushl $120
8010689f:	6a 78                	push   $0x78
  jmp alltraps
801068a1:	e9 41 ee ff ff       	jmp    801056e7 <alltraps>
...
801068a6:	6a 00                	push   $0x0
  pushl $121
801068a8:	6a 79                	push   $0x79
  jmp alltraps
801068aa:	e9 38 ee ff ff       	jmp    801056e7 <alltraps>
...
801068af:	6a 00                	push   $0x0
  pushl $122
801068b1:	6a 7a                	push   $0x7a
  jmp alltraps
801068b3:	e9 2f ee ff ff       	jmp    801056e7 <alltraps>
...
801068b8:	6a 00                	push   $0x0
  pushl $123
801068ba:	6a 7b                	push   $0x7b
  jmp alltraps
801068bc:	e9 26 ee ff ff       	jmp    801056e7 <alltraps>
...
801068c1:	6a 00                	push   $0x0
  pushl $124
801068c3:	6a 7c                	push   $0x7c
  jmp alltraps
801068c5:	e9 1d ee ff ff       	jmp    801056e7 <alltraps>
...
801068ca:	6a 00                	push   $0x0
  pushl $125
801068cc:	6a 7d                	push   $0x7d
  jmp alltraps
801068ce:	e9 14 ee ff ff       	jmp    801056e7 <alltraps>
...
801068d3:	6a 00                	push   $0x0
  pushl $126
801068d5:	6a 7e                	push   $0x7e
  jmp alltraps
801068d7:	e9 0b ee ff ff       	jmp    801056e7 <alltraps>
...
801068dc:	6a 00                	push   $0x0
  pushl $127
801068de:	6a 7f                	push   $0x7f
  jmp alltraps
801068e0:	e9 02 ee ff ff       	jmp    801056e7 <alltraps>
...
801068e5:	6a 00                	push   $0x0
  pushl $128
801068e7:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801068ec:	e9 f6 ed ff ff       	jmp    801056e7 <alltraps>
...
801068f1:	6a 00                	push   $0x0
  pushl $129
801068f3:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801068f8:	e9 ea ed ff ff       	jmp    801056e7 <alltraps>
...
801068fd:	6a 00                	push   $0x0
  pushl $130
801068ff:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106904:	e9 de ed ff ff       	jmp    801056e7 <alltraps>
...
80106909:	6a 00                	push   $0x0
  pushl $131
8010690b:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106910:	e9 d2 ed ff ff       	jmp    801056e7 <alltraps>
...
80106915:	6a 00                	push   $0x0
  pushl $132
80106917:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010691c:	e9 c6 ed ff ff       	jmp    801056e7 <alltraps>
...
80106921:	6a 00                	push   $0x0
  pushl $133
80106923:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106928:	e9 ba ed ff ff       	jmp    801056e7 <alltraps>
...
8010692d:	6a 00                	push   $0x0
  pushl $134
8010692f:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106934:	e9 ae ed ff ff       	jmp    801056e7 <alltraps>
...
80106939:	6a 00                	push   $0x0
  pushl $135
8010693b:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106940:	e9 a2 ed ff ff       	jmp    801056e7 <alltraps>
...
80106945:	6a 00                	push   $0x0
  pushl $136
80106947:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010694c:	e9 96 ed ff ff       	jmp    801056e7 <alltraps>
...
80106951:	6a 00                	push   $0x0
  pushl $137
80106953:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106958:	e9 8a ed ff ff       	jmp    801056e7 <alltraps>
...
8010695d:	6a 00                	push   $0x0
  pushl $138
8010695f:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106964:	e9 7e ed ff ff       	jmp    801056e7 <alltraps>
...
80106969:	6a 00                	push   $0x0
  pushl $139
8010696b:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106970:	e9 72 ed ff ff       	jmp    801056e7 <alltraps>
...
80106975:	6a 00                	push   $0x0
  pushl $140
80106977:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010697c:	e9 66 ed ff ff       	jmp    801056e7 <alltraps>
...
80106981:	6a 00                	push   $0x0
  pushl $141
80106983:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106988:	e9 5a ed ff ff       	jmp    801056e7 <alltraps>
...
8010698d:	6a 00                	push   $0x0
  pushl $142
8010698f:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106994:	e9 4e ed ff ff       	jmp    801056e7 <alltraps>
...
80106999:	6a 00                	push   $0x0
  pushl $143
8010699b:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801069a0:	e9 42 ed ff ff       	jmp    801056e7 <alltraps>
...
801069a5:	6a 00                	push   $0x0
  pushl $144
801069a7:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801069ac:	e9 36 ed ff ff       	jmp    801056e7 <alltraps>
...
801069b1:	6a 00                	push   $0x0
  pushl $145
801069b3:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801069b8:	e9 2a ed ff ff       	jmp    801056e7 <alltraps>
...
801069bd:	6a 00                	push   $0x0
  pushl $146
801069bf:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801069c4:	e9 1e ed ff ff       	jmp    801056e7 <alltraps>
...
801069c9:	6a 00                	push   $0x0
  pushl $147
801069cb:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801069d0:	e9 12 ed ff ff       	jmp    801056e7 <alltraps>
...
801069d5:	6a 00                	push   $0x0
  pushl $148
801069d7:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801069dc:	e9 06 ed ff ff       	jmp    801056e7 <alltraps>
...
801069e1:	6a 00                	push   $0x0
  pushl $149
801069e3:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801069e8:	e9 fa ec ff ff       	jmp    801056e7 <alltraps>
...
801069ed:	6a 00                	push   $0x0
  pushl $150
801069ef:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801069f4:	e9 ee ec ff ff       	jmp    801056e7 <alltraps>
...
801069f9:	6a 00                	push   $0x0
  pushl $151
801069fb:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106a00:	e9 e2 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a05:	6a 00                	push   $0x0
  pushl $152
80106a07:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80106a0c:	e9 d6 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a11:	6a 00                	push   $0x0
  pushl $153
80106a13:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106a18:	e9 ca ec ff ff       	jmp    801056e7 <alltraps>
...
80106a1d:	6a 00                	push   $0x0
  pushl $154
80106a1f:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106a24:	e9 be ec ff ff       	jmp    801056e7 <alltraps>
...
80106a29:	6a 00                	push   $0x0
  pushl $155
80106a2b:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106a30:	e9 b2 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a35:	6a 00                	push   $0x0
  pushl $156
80106a37:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80106a3c:	e9 a6 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a41:	6a 00                	push   $0x0
  pushl $157
80106a43:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
80106a48:	e9 9a ec ff ff       	jmp    801056e7 <alltraps>
...
80106a4d:	6a 00                	push   $0x0
  pushl $158
80106a4f:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106a54:	e9 8e ec ff ff       	jmp    801056e7 <alltraps>
...
80106a59:	6a 00                	push   $0x0
  pushl $159
80106a5b:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106a60:	e9 82 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a65:	6a 00                	push   $0x0
  pushl $160
80106a67:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80106a6c:	e9 76 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a71:	6a 00                	push   $0x0
  pushl $161
80106a73:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
80106a78:	e9 6a ec ff ff       	jmp    801056e7 <alltraps>
...
80106a7d:	6a 00                	push   $0x0
  pushl $162
80106a7f:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106a84:	e9 5e ec ff ff       	jmp    801056e7 <alltraps>
...
80106a89:	6a 00                	push   $0x0
  pushl $163
80106a8b:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106a90:	e9 52 ec ff ff       	jmp    801056e7 <alltraps>
...
80106a95:	6a 00                	push   $0x0
  pushl $164
80106a97:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80106a9c:	e9 46 ec ff ff       	jmp    801056e7 <alltraps>
...
80106aa1:	6a 00                	push   $0x0
  pushl $165
80106aa3:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106aa8:	e9 3a ec ff ff       	jmp    801056e7 <alltraps>
...
80106aad:	6a 00                	push   $0x0
  pushl $166
80106aaf:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106ab4:	e9 2e ec ff ff       	jmp    801056e7 <alltraps>
...
80106ab9:	6a 00                	push   $0x0
  pushl $167
80106abb:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106ac0:	e9 22 ec ff ff       	jmp    801056e7 <alltraps>
...
80106ac5:	6a 00                	push   $0x0
  pushl $168
80106ac7:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80106acc:	e9 16 ec ff ff       	jmp    801056e7 <alltraps>
...
80106ad1:	6a 00                	push   $0x0
  pushl $169
80106ad3:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106ad8:	e9 0a ec ff ff       	jmp    801056e7 <alltraps>
...
80106add:	6a 00                	push   $0x0
  pushl $170
80106adf:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106ae4:	e9 fe eb ff ff       	jmp    801056e7 <alltraps>
...
80106ae9:	6a 00                	push   $0x0
  pushl $171
80106aeb:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106af0:	e9 f2 eb ff ff       	jmp    801056e7 <alltraps>
...
80106af5:	6a 00                	push   $0x0
  pushl $172
80106af7:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80106afc:	e9 e6 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b01:	6a 00                	push   $0x0
  pushl $173
80106b03:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106b08:	e9 da eb ff ff       	jmp    801056e7 <alltraps>
...
80106b0d:	6a 00                	push   $0x0
  pushl $174
80106b0f:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106b14:	e9 ce eb ff ff       	jmp    801056e7 <alltraps>
...
80106b19:	6a 00                	push   $0x0
  pushl $175
80106b1b:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106b20:	e9 c2 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b25:	6a 00                	push   $0x0
  pushl $176
80106b27:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80106b2c:	e9 b6 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b31:	6a 00                	push   $0x0
  pushl $177
80106b33:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106b38:	e9 aa eb ff ff       	jmp    801056e7 <alltraps>
...
80106b3d:	6a 00                	push   $0x0
  pushl $178
80106b3f:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106b44:	e9 9e eb ff ff       	jmp    801056e7 <alltraps>
...
80106b49:	6a 00                	push   $0x0
  pushl $179
80106b4b:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106b50:	e9 92 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b55:	6a 00                	push   $0x0
  pushl $180
80106b57:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80106b5c:	e9 86 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b61:	6a 00                	push   $0x0
  pushl $181
80106b63:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
80106b68:	e9 7a eb ff ff       	jmp    801056e7 <alltraps>
...
80106b6d:	6a 00                	push   $0x0
  pushl $182
80106b6f:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106b74:	e9 6e eb ff ff       	jmp    801056e7 <alltraps>
...
80106b79:	6a 00                	push   $0x0
  pushl $183
80106b7b:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106b80:	e9 62 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b85:	6a 00                	push   $0x0
  pushl $184
80106b87:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
80106b8c:	e9 56 eb ff ff       	jmp    801056e7 <alltraps>
...
80106b91:	6a 00                	push   $0x0
  pushl $185
80106b93:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
80106b98:	e9 4a eb ff ff       	jmp    801056e7 <alltraps>
...
80106b9d:	6a 00                	push   $0x0
  pushl $186
80106b9f:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106ba4:	e9 3e eb ff ff       	jmp    801056e7 <alltraps>
...
80106ba9:	6a 00                	push   $0x0
  pushl $187
80106bab:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106bb0:	e9 32 eb ff ff       	jmp    801056e7 <alltraps>
...
80106bb5:	6a 00                	push   $0x0
  pushl $188
80106bb7:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80106bbc:	e9 26 eb ff ff       	jmp    801056e7 <alltraps>
...
80106bc1:	6a 00                	push   $0x0
  pushl $189
80106bc3:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106bc8:	e9 1a eb ff ff       	jmp    801056e7 <alltraps>
...
80106bcd:	6a 00                	push   $0x0
  pushl $190
80106bcf:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106bd4:	e9 0e eb ff ff       	jmp    801056e7 <alltraps>
...
80106bd9:	6a 00                	push   $0x0
  pushl $191
80106bdb:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106be0:	e9 02 eb ff ff       	jmp    801056e7 <alltraps>
...
80106be5:	6a 00                	push   $0x0
  pushl $192
80106be7:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80106bec:	e9 f6 ea ff ff       	jmp    801056e7 <alltraps>
...
80106bf1:	6a 00                	push   $0x0
  pushl $193
80106bf3:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106bf8:	e9 ea ea ff ff       	jmp    801056e7 <alltraps>
...
80106bfd:	6a 00                	push   $0x0
  pushl $194
80106bff:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106c04:	e9 de ea ff ff       	jmp    801056e7 <alltraps>
...
80106c09:	6a 00                	push   $0x0
  pushl $195
80106c0b:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106c10:	e9 d2 ea ff ff       	jmp    801056e7 <alltraps>
...
80106c15:	6a 00                	push   $0x0
  pushl $196
80106c17:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80106c1c:	e9 c6 ea ff ff       	jmp    801056e7 <alltraps>
...
80106c21:	6a 00                	push   $0x0
  pushl $197
80106c23:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106c28:	e9 ba ea ff ff       	jmp    801056e7 <alltraps>
...
80106c2d:	6a 00                	push   $0x0
  pushl $198
80106c2f:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106c34:	e9 ae ea ff ff       	jmp    801056e7 <alltraps>
...
80106c39:	6a 00                	push   $0x0
  pushl $199
80106c3b:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106c40:	e9 a2 ea ff ff       	jmp    801056e7 <alltraps>
...
80106c45:	6a 00                	push   $0x0
  pushl $200
80106c47:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80106c4c:	e9 96 ea ff ff       	jmp    801056e7 <alltraps>
...
80106c51:	6a 00                	push   $0x0
  pushl $201
80106c53:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
80106c58:	e9 8a ea ff ff       	jmp    801056e7 <alltraps>
...
80106c5d:	6a 00                	push   $0x0
  pushl $202
80106c5f:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106c64:	e9 7e ea ff ff       	jmp    801056e7 <alltraps>
...
80106c69:	6a 00                	push   $0x0
  pushl $203
80106c6b:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106c70:	e9 72 ea ff ff       	jmp    801056e7 <alltraps>
...
80106c75:	6a 00                	push   $0x0
  pushl $204
80106c77:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80106c7c:	e9 66 ea ff ff       	jmp    801056e7 <alltraps>
...
80106c81:	6a 00                	push   $0x0
  pushl $205
80106c83:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
80106c88:	e9 5a ea ff ff       	jmp    801056e7 <alltraps>
...
80106c8d:	6a 00                	push   $0x0
  pushl $206
80106c8f:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106c94:	e9 4e ea ff ff       	jmp    801056e7 <alltraps>
...
80106c99:	6a 00                	push   $0x0
  pushl $207
80106c9b:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106ca0:	e9 42 ea ff ff       	jmp    801056e7 <alltraps>
...
80106ca5:	6a 00                	push   $0x0
  pushl $208
80106ca7:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80106cac:	e9 36 ea ff ff       	jmp    801056e7 <alltraps>
...
80106cb1:	6a 00                	push   $0x0
  pushl $209
80106cb3:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106cb8:	e9 2a ea ff ff       	jmp    801056e7 <alltraps>
...
80106cbd:	6a 00                	push   $0x0
  pushl $210
80106cbf:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106cc4:	e9 1e ea ff ff       	jmp    801056e7 <alltraps>
...
80106cc9:	6a 00                	push   $0x0
  pushl $211
80106ccb:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106cd0:	e9 12 ea ff ff       	jmp    801056e7 <alltraps>
...
80106cd5:	6a 00                	push   $0x0
  pushl $212
80106cd7:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80106cdc:	e9 06 ea ff ff       	jmp    801056e7 <alltraps>
...
80106ce1:	6a 00                	push   $0x0
  pushl $213
80106ce3:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106ce8:	e9 fa e9 ff ff       	jmp    801056e7 <alltraps>
...
80106ced:	6a 00                	push   $0x0
  pushl $214
80106cef:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106cf4:	e9 ee e9 ff ff       	jmp    801056e7 <alltraps>
...
80106cf9:	6a 00                	push   $0x0
  pushl $215
80106cfb:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106d00:	e9 e2 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d05:	6a 00                	push   $0x0
  pushl $216
80106d07:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80106d0c:	e9 d6 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d11:	6a 00                	push   $0x0
  pushl $217
80106d13:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106d18:	e9 ca e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d1d:	6a 00                	push   $0x0
  pushl $218
80106d1f:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106d24:	e9 be e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d29:	6a 00                	push   $0x0
  pushl $219
80106d2b:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106d30:	e9 b2 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d35:	6a 00                	push   $0x0
  pushl $220
80106d37:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80106d3c:	e9 a6 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d41:	6a 00                	push   $0x0
  pushl $221
80106d43:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80106d48:	e9 9a e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d4d:	6a 00                	push   $0x0
  pushl $222
80106d4f:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106d54:	e9 8e e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d59:	6a 00                	push   $0x0
  pushl $223
80106d5b:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106d60:	e9 82 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d65:	6a 00                	push   $0x0
  pushl $224
80106d67:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80106d6c:	e9 76 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d71:	6a 00                	push   $0x0
  pushl $225
80106d73:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80106d78:	e9 6a e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d7d:	6a 00                	push   $0x0
  pushl $226
80106d7f:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106d84:	e9 5e e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d89:	6a 00                	push   $0x0
  pushl $227
80106d8b:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106d90:	e9 52 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106d95:	6a 00                	push   $0x0
  pushl $228
80106d97:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80106d9c:	e9 46 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106da1:	6a 00                	push   $0x0
  pushl $229
80106da3:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106da8:	e9 3a e9 ff ff       	jmp    801056e7 <alltraps>
...
80106dad:	6a 00                	push   $0x0
  pushl $230
80106daf:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106db4:	e9 2e e9 ff ff       	jmp    801056e7 <alltraps>
...
80106db9:	6a 00                	push   $0x0
  pushl $231
80106dbb:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106dc0:	e9 22 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106dc5:	6a 00                	push   $0x0
  pushl $232
80106dc7:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80106dcc:	e9 16 e9 ff ff       	jmp    801056e7 <alltraps>
...
80106dd1:	6a 00                	push   $0x0
  pushl $233
80106dd3:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106dd8:	e9 0a e9 ff ff       	jmp    801056e7 <alltraps>
...
80106ddd:	6a 00                	push   $0x0
  pushl $234
80106ddf:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106de4:	e9 fe e8 ff ff       	jmp    801056e7 <alltraps>
...
80106de9:	6a 00                	push   $0x0
  pushl $235
80106deb:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106df0:	e9 f2 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106df5:	6a 00                	push   $0x0
  pushl $236
80106df7:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80106dfc:	e9 e6 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e01:	6a 00                	push   $0x0
  pushl $237
80106e03:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106e08:	e9 da e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e0d:	6a 00                	push   $0x0
  pushl $238
80106e0f:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106e14:	e9 ce e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e19:	6a 00                	push   $0x0
  pushl $239
80106e1b:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106e20:	e9 c2 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e25:	6a 00                	push   $0x0
  pushl $240
80106e27:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106e2c:	e9 b6 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e31:	6a 00                	push   $0x0
  pushl $241
80106e33:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106e38:	e9 aa e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e3d:	6a 00                	push   $0x0
  pushl $242
80106e3f:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106e44:	e9 9e e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e49:	6a 00                	push   $0x0
  pushl $243
80106e4b:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106e50:	e9 92 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e55:	6a 00                	push   $0x0
  pushl $244
80106e57:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106e5c:	e9 86 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e61:	6a 00                	push   $0x0
  pushl $245
80106e63:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106e68:	e9 7a e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e6d:	6a 00                	push   $0x0
  pushl $246
80106e6f:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106e74:	e9 6e e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e79:	6a 00                	push   $0x0
  pushl $247
80106e7b:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106e80:	e9 62 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e85:	6a 00                	push   $0x0
  pushl $248
80106e87:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106e8c:	e9 56 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e91:	6a 00                	push   $0x0
  pushl $249
80106e93:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106e98:	e9 4a e8 ff ff       	jmp    801056e7 <alltraps>
...
80106e9d:	6a 00                	push   $0x0
  pushl $250
80106e9f:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106ea4:	e9 3e e8 ff ff       	jmp    801056e7 <alltraps>
...
80106ea9:	6a 00                	push   $0x0
  pushl $251
80106eab:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106eb0:	e9 32 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106eb5:	6a 00                	push   $0x0
  pushl $252
80106eb7:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106ebc:	e9 26 e8 ff ff       	jmp    801056e7 <alltraps>
...
80106ec1:	6a 00                	push   $0x0
  pushl $253
80106ec3:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106ec8:	e9 1a e8 ff ff       	jmp    801056e7 <alltraps>
...
80106ecd:	6a 00                	push   $0x0
  pushl $254
80106ecf:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106ed4:	e9 0e e8 ff ff       	jmp    801056e7 <alltraps>
...
80106ed9:	6a 00                	push   $0x0
  pushl $255
80106edb:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106ee0:	e9 02 e8 ff ff       	jmp    801056e7 <alltraps>
80106ee5:	66 90                	xchg   %ax,%ax
...
{
80106ef8:	89 d7                	mov    %edx,%edi
  pde = &pgdir[PDX(va)];
80106efa:	c1 eb 16             	shr    $0x16,%ebx
80106efd:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80106f00:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106f03:	8b 06                	mov    (%esi),%eax
80106f05:	a8 01                	test   $0x1,%al
80106f07:	74 27                	je     80106f30 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106f09:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106f0e:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80106f14:	c1 ef 0a             	shr    $0xa,%edi
}
80106f17:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106f1a:	89 fa                	mov    %edi,%edx
80106f1c:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106f22:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
80106f25:	5b                   	pop    %ebx
80106f26:	5e                   	pop    %esi
80106f27:	5f                   	pop    %edi
...
80106f34:	e8 97 b5 ff ff       	call   801024d0 <kalloc>
80106f39:	85 c0                	test   %eax,%eax
80106f3b:	89 c3                	mov    %eax,%ebx
...
80106f81:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106f84:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
80106f88:	8b 7d 08             	mov    0x8(%ebp),%edi
...
80106f96:	29 df                	sub    %ebx,%edi
80106f98:	83 c8 01             	or     $0x1,%eax
80106f9b:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106f9e:	eb 15                	jmp    80106fb5 <mappages+0x45>
    if(*pte & PTE_P)
80106fa0:	f6 00 01             	testb  $0x1,(%eax)
80106fa3:	75 45                	jne    80106fea <mappages+0x7a>
    *pte = pa | perm | PTE_P;
80106fa5:	0b 75 dc             	or     -0x24(%ebp),%esi
    if(a == last)
80106fa8:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
    *pte = pa | perm | PTE_P;
80106fab:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106fad:	74 31                	je     80106fe0 <mappages+0x70>
      break;
    a += PGSIZE;
80106faf:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106fb5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106fb8:	b9 01 00 00 00       	mov    $0x1,%ecx
80106fbd:	89 da                	mov    %ebx,%edx
80106fbf:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80106fc2:	e8 29 ff ff ff       	call   80106ef0 <walkpgdir>
80106fc7:	85 c0                	test   %eax,%eax
80106fc9:	75 d5                	jne    80106fa0 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106fed:	68 00 91 10 80       	push   $0x80109100
...
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80107014:	83 ec 1c             	sub    $0x1c,%esp
80107017:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010701a:	39 d3                	cmp    %edx,%ebx
8010701c:	73 66                	jae    80107084 <deallocuvm.part.0+0x84>
8010701e:	89 d6                	mov    %edx,%esi
80107020:	eb 3d                	jmp    8010705f <deallocuvm.part.0+0x5f>
80107022:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80107028:	8b 10                	mov    (%eax),%edx
8010702a:	f6 c2 01             	test   $0x1,%dl
8010702d:	74 26                	je     80107055 <deallocuvm.part.0+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010702f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80107035:	74 58                	je     8010708f <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80107037:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010703a:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80107040:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      kfree(v);
80107043:	52                   	push   %edx
80107044:	e8 d7 b2 ff ff       	call   80102320 <kfree>
      *pte = 0;
80107049:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010704c:	83 c4 10             	add    $0x10,%esp
8010704f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
80107055:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010705b:	39 f3                	cmp    %esi,%ebx
8010705d:	73 25                	jae    80107084 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010705f:	31 c9                	xor    %ecx,%ecx
80107061:	89 da                	mov    %ebx,%edx
80107063:	89 f8                	mov    %edi,%eax
80107065:	e8 86 fe ff ff       	call   80106ef0 <walkpgdir>
    if(!pte)
8010706a:	85 c0                	test   %eax,%eax
8010706c:	75 ba                	jne    80107028 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
8010706e:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80107074:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
8010707a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107080:	39 f3                	cmp    %esi,%ebx
80107082:	72 db                	jb     8010705f <deallocuvm.part.0+0x5f>
    }
  }
  return newsz;
}
80107084:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80107092:	68 86 7a 10 80       	push   $0x80107a86
...
801070a3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801070a6:	e8 25 c7 ff ff       	call   801037d0 <cpuid>
801070ab:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
  pd[0] = size-1;
801070b1:	ba 2f 00 00 00       	mov    $0x2f,%edx
801070b6:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
801070ba:	c7 80 f8 4b 11 80 ff 	movl   $0xffff,-0x7feeb408(%eax)
801070c1:	ff 00 00 
801070c4:	c7 80 fc 4b 11 80 00 	movl   $0xcf9a00,-0x7feeb404(%eax)
801070cb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801070ce:	c7 80 00 4c 11 80 ff 	movl   $0xffff,-0x7feeb400(%eax)
801070d5:	ff 00 00 
801070d8:	c7 80 04 4c 11 80 00 	movl   $0xcf9200,-0x7feeb3fc(%eax)
801070df:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801070e2:	c7 80 08 4c 11 80 ff 	movl   $0xffff,-0x7feeb3f8(%eax)
801070e9:	ff 00 00 
801070ec:	c7 80 0c 4c 11 80 00 	movl   $0xcffa00,-0x7feeb3f4(%eax)
801070f3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801070f6:	c7 80 10 4c 11 80 ff 	movl   $0xffff,-0x7feeb3f0(%eax)
801070fd:	ff 00 00 
80107100:	c7 80 14 4c 11 80 00 	movl   $0xcff200,-0x7feeb3ec(%eax)
80107107:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010710a:	05 f0 4b 11 80       	add    $0x80114bf0,%eax
  pd[1] = (uint)p;
...
80107130:	a1 a4 78 11 80       	mov    0x801178a4,%eax
{
...
80107159:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(p == 0)
8010715c:	85 db                	test   %ebx,%ebx
8010715e:	0f 84 cb 00 00 00    	je     8010722f <switchuvm+0xdf>
  if(p->kstack == 0)
80107164:	8b 43 08             	mov    0x8(%ebx),%eax
80107167:	85 c0                	test   %eax,%eax
80107169:	0f 84 da 00 00 00    	je     80107249 <switchuvm+0xf9>
  if(p->pgdir == 0)
8010716f:	8b 43 04             	mov    0x4(%ebx),%eax
80107172:	85 c0                	test   %eax,%eax
80107174:	0f 84 c2 00 00 00    	je     8010723c <switchuvm+0xec>
  pushcli();
8010717a:	e8 21 d1 ff ff       	call   801042a0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010717f:	e8 cc c5 ff ff       	call   80103750 <mycpu>
80107184:	89 c6                	mov    %eax,%esi
80107186:	e8 c5 c5 ff ff       	call   80103750 <mycpu>
8010718b:	89 c7                	mov    %eax,%edi
8010718d:	e8 be c5 ff ff       	call   80103750 <mycpu>
80107192:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107195:	83 c7 08             	add    $0x8,%edi
80107198:	e8 b3 c5 ff ff       	call   80103750 <mycpu>
...
801071ab:	66 89 96 98 00 00 00 	mov    %dx,0x98(%esi)
801071b2:	66 89 be 9a 00 00 00 	mov    %di,0x9a(%esi)
801071b9:	88 86 9f 00 00 00    	mov    %al,0x9f(%esi)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801071bf:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
801071c4:	83 c1 08             	add    $0x8,%ecx
801071c7:	c1 e9 10             	shr    $0x10,%ecx
801071ca:	88 8e 9c 00 00 00    	mov    %cl,0x9c(%esi)
801071d0:	b9 99 40 00 00       	mov    $0x4099,%ecx
801071d5:	66 89 8e 9d 00 00 00 	mov    %cx,0x9d(%esi)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801071dc:	be 10 00 00 00       	mov    $0x10,%esi
  mycpu()->gdt[SEG_TSS].s = 0;
801071e1:	e8 6a c5 ff ff       	call   80103750 <mycpu>
801071e6:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801071ed:	e8 5e c5 ff ff       	call   80103750 <mycpu>
801071f2:	66 89 70 10          	mov    %si,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801071f6:	8b 73 08             	mov    0x8(%ebx),%esi
801071f9:	e8 52 c5 ff ff       	call   80103750 <mycpu>
801071fe:	81 c6 00 10 00 00    	add    $0x1000,%esi
80107204:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80107207:	e8 44 c5 ff ff       	call   80103750 <mycpu>
...
80107229:	5d                   	pop    %ebp
  popcli();
8010722a:	e9 71 d1 ff ff       	jmp    801043a0 <popcli>
    panic("switchuvm: no process");
8010722f:	83 ec 0c             	sub    $0xc,%esp
80107232:	68 06 91 10 80       	push   $0x80109106
80107237:	e8 54 91 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
8010723c:	83 ec 0c             	sub    $0xc,%esp
8010723f:	68 31 91 10 80       	push   $0x80109131
80107244:	e8 47 91 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80107249:	83 ec 0c             	sub    $0xc,%esp
8010724c:	68 1c 91 10 80       	push   $0x8010911c
...
8010727b:	77 49                	ja     801072c6 <inituvm+0x66>
  mem = kalloc();
8010727d:	e8 4e b2 ff ff       	call   801024d0 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010728f:	e8 cc d1 ff ff       	call   80104460 <memset>
...
801072a9:	e8 c2 fc ff ff       	call   80106f70 <mappages>
  memmove(mem, init, sz);
...
801072c0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801072c1:	e9 4a d2 ff ff       	jmp    80104510 <memmove>
    panic("inituvm: more than a page");
801072c6:	83 ec 0c             	sub    $0xc,%esp
801072c9:	68 45 91 10 80       	push   $0x80109145
...
80107323:	e8 c8 fb ff ff       	call   80106ef0 <walkpgdir>
...
801073ae:	0f 88 8e 00 00 00    	js     80107442 <allocuvm+0xa2>
  if(newsz < oldsz)
801073b4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801073b7:	0f 82 93 00 00 00    	jb     80107450 <allocuvm+0xb0>
  a = PGROUNDUP(oldsz);
801073bd:	8b 45 0c             	mov    0xc(%ebp),%eax
801073c0:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801073c6:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
801073cc:	39 5d 10             	cmp    %ebx,0x10(%ebp)
801073cf:	0f 86 7e 00 00 00    	jbe    80107453 <allocuvm+0xb3>
801073d5:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801073d8:	8b 7d 08             	mov    0x8(%ebp),%edi
801073db:	eb 42                	jmp    8010741f <allocuvm+0x7f>
...
801073eb:	e8 70 d0 ff ff       	call   80104460 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801073f0:	58                   	pop    %eax
801073f1:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801073f7:	b9 00 10 00 00       	mov    $0x1000,%ecx
801073fc:	5a                   	pop    %edx
801073fd:	6a 06                	push   $0x6
801073ff:	50                   	push   %eax
80107400:	89 da                	mov    %ebx,%edx
80107402:	89 f8                	mov    %edi,%eax
80107404:	e8 67 fb ff ff       	call   80106f70 <mappages>
80107409:	83 c4 10             	add    $0x10,%esp
8010740c:	85 c0                	test   %eax,%eax
8010740e:	78 50                	js     80107460 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80107410:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107416:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80107419:	0f 86 81 00 00 00    	jbe    801074a0 <allocuvm+0x100>
    mem = kalloc();
8010741f:	e8 ac b0 ff ff       	call   801024d0 <kalloc>
    if(mem == 0){
80107424:	85 c0                	test   %eax,%eax
    mem = kalloc();
80107426:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80107428:	75 b6                	jne    801073e0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
8010742a:	83 ec 0c             	sub    $0xc,%esp
8010742d:	68 7d 91 10 80       	push   $0x8010917d
80107432:	e8 29 92 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80107437:	83 c4 10             	add    $0x10,%esp
8010743a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010743d:	39 45 10             	cmp    %eax,0x10(%ebp)
80107440:	77 6e                	ja     801074b0 <allocuvm+0x110>
}
80107442:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80107445:	31 ff                	xor    %edi,%edi
}
80107447:	89 f8                	mov    %edi,%eax
80107449:	5b                   	pop    %ebx
8010744a:	5e                   	pop    %esi
8010744b:	5f                   	pop    %edi
8010744c:	5d                   	pop    %ebp
...
8010744e:	66 90                	xchg   %ax,%ax
    return oldsz;
80107450:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
...
80107463:	68 95 91 10 80       	push   $0x80109195
80107468:	e8 f3 91 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
8010746d:	83 c4 10             	add    $0x10,%esp
80107470:	8b 45 0c             	mov    0xc(%ebp),%eax
80107473:	39 45 10             	cmp    %eax,0x10(%ebp)
80107476:	76 0d                	jbe    80107485 <allocuvm+0xe5>
80107478:	89 c1                	mov    %eax,%ecx
8010747a:	8b 55 10             	mov    0x10(%ebp),%edx
8010747d:	8b 45 08             	mov    0x8(%ebp),%eax
80107480:	e8 7b fb ff ff       	call   80107000 <deallocuvm.part.0>
      kfree(mem);
...
8010748b:	e8 90 ae ff ff       	call   80102320 <kfree>
      return 0;
...
801074a0:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801074a3:	8d 65 f4             	lea    -0xc(%ebp),%esp
801074a6:	5b                   	pop    %ebx
801074a7:	89 f8                	mov    %edi,%eax
801074a9:	5e                   	pop    %esi
801074aa:	5f                   	pop    %edi
801074ab:	5d                   	pop    %ebp
801074ac:	c3                   	ret    
801074ad:	8d 76 00             	lea    0x0(%esi),%esi
801074b0:	89 c1                	mov    %eax,%ecx
801074b2:	8b 55 10             	mov    0x10(%ebp),%edx
801074b5:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
801074b8:	31 ff                	xor    %edi,%edi
801074ba:	e8 41 fb ff ff       	call   80107000 <deallocuvm.part.0>
801074bf:	eb 92                	jmp    80107453 <allocuvm+0xb3>
801074c1:	eb 0d                	jmp    801074d0 <deallocuvm>
801074c3:	90                   	nop
801074c4:	90                   	nop
801074c5:	90                   	nop
801074c6:	90                   	nop
...
801074e0:	5d                   	pop    %ebp
801074e1:	e9 1a fb ff ff       	jmp    80107000 <deallocuvm.part.0>
...
80107519:	e8 e2 fa ff ff       	call   80107000 <deallocuvm.part.0>
8010751e:	89 f3                	mov    %esi,%ebx
...
8010754e:	e8 cd ad ff ff       	call   80102320 <kfree>
80107553:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107556:	39 fb                	cmp    %edi,%ebx
...
80107563:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107564:	e9 b7 ad ff ff       	jmp    80102320 <kfree>
    panic("freevm: no pgdir");
80107569:	83 ec 0c             	sub    $0xc,%esp
8010756c:	68 b1 91 10 80       	push   $0x801091b1
...
801075ca:	81 fb 60 c8 10 80    	cmp    $0x8010c860,%ebx
...
8010760b:	a3 a4 78 11 80       	mov    %eax,0x801178a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107621:	31 c9                	xor    %ecx,%ecx
{
80107623:	89 e5                	mov    %esp,%ebp
80107625:	83 ec 08             	sub    $0x8,%esp
  pte = walkpgdir(pgdir, uva, 0);
80107628:	8b 55 0c             	mov    0xc(%ebp),%edx
8010762b:	8b 45 08             	mov    0x8(%ebp),%eax
8010762e:	e8 bd f8 ff ff       	call   80106ef0 <walkpgdir>
  if(pte == 0)
80107633:	85 c0                	test   %eax,%eax
80107635:	74 05                	je     8010763c <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
80107637:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010763a:	c9                   	leave  
8010763b:	c3                   	ret    
    panic("clearpteu");
8010763c:	83 ec 0c             	sub    $0xc,%esp
8010763f:	68 c2 91 10 80       	push   $0x801091c2
...
80107656:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107659:	e8 22 ff ff ff       	call   80107580 <setupkvm>
8010765e:	85 c0                	test   %eax,%eax
80107660:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107663:	0f 84 a0 00 00 00    	je     80107709 <copyuvm+0xb9>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107669:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010766c:	85 c9                	test   %ecx,%ecx
8010766e:	0f 84 95 00 00 00    	je     80107709 <copyuvm+0xb9>
80107674:	31 f6                	xor    %esi,%esi
80107676:	eb 4e                	jmp    801076c6 <copyuvm+0x76>
80107678:	90                   	nop
...
80107691:	57                   	push   %edi
80107692:	50                   	push   %eax
80107693:	e8 78 ce ff ff       	call   80104510 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80107698:	58                   	pop    %eax
80107699:	5a                   	pop    %edx
8010769a:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010769d:	8b 45 e0             	mov    -0x20(%ebp),%eax
801076a0:	b9 00 10 00 00       	mov    $0x1000,%ecx
801076a5:	53                   	push   %ebx
801076a6:	81 c2 00 00 00 80    	add    $0x80000000,%edx
801076ac:	52                   	push   %edx
801076ad:	89 f2                	mov    %esi,%edx
801076af:	e8 bc f8 ff ff       	call   80106f70 <mappages>
801076b4:	83 c4 10             	add    $0x10,%esp
801076b7:	85 c0                	test   %eax,%eax
801076b9:	78 39                	js     801076f4 <copyuvm+0xa4>
  for(i = 0; i < sz; i += PGSIZE){
801076bb:	81 c6 00 10 00 00    	add    $0x1000,%esi
801076c1:	39 75 0c             	cmp    %esi,0xc(%ebp)
801076c4:	76 43                	jbe    80107709 <copyuvm+0xb9>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801076c6:	8b 45 08             	mov    0x8(%ebp),%eax
801076c9:	31 c9                	xor    %ecx,%ecx
801076cb:	89 f2                	mov    %esi,%edx
801076cd:	e8 1e f8 ff ff       	call   80106ef0 <walkpgdir>
801076d2:	85 c0                	test   %eax,%eax
801076d4:	74 3e                	je     80107714 <copyuvm+0xc4>
    if(!(*pte & PTE_P))
801076d6:	8b 18                	mov    (%eax),%ebx
801076d8:	f6 c3 01             	test   $0x1,%bl
801076db:	74 44                	je     80107721 <copyuvm+0xd1>
    pa = PTE_ADDR(*pte);
801076dd:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
801076df:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
    pa = PTE_ADDR(*pte);
801076e5:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801076eb:	e8 e0 ad ff ff       	call   801024d0 <kalloc>
801076f0:	85 c0                	test   %eax,%eax
801076f2:	75 8c                	jne    80107680 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
801076f7:	ff 75 e0             	pushl  -0x20(%ebp)
801076fa:	e8 01 fe ff ff       	call   80107500 <freevm>
  return 0;
801076ff:	83 c4 10             	add    $0x10,%esp
80107702:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
80107717:	68 cc 91 10 80       	push   $0x801091cc
8010771c:	e8 6f 8c ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80107721:	83 ec 0c             	sub    $0xc,%esp
80107724:	68 e6 91 10 80       	push   $0x801091e6
80107729:	e8 62 8c ff ff       	call   80100390 <panic>
...
8010773e:	e8 ad f7 ff ff       	call   80106ef0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107746:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107748:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
8010774d:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107750:	05 00 00 00 80       	add    $0x80000000,%eax
80107755:	83 fa 05             	cmp    $0x5,%edx
80107758:	ba 00 00 00 00       	mov    $0x0,%edx
8010775d:	0f 45 c2             	cmovne %edx,%eax
}
80107760:	c3                   	ret    
80107761:	eb 0d                	jmp    80107770 <copyout>
80107763:	90                   	nop
80107764:	90                   	nop
80107765:	90                   	nop
80107766:	90                   	nop
...
801077af:	e8 5c cd ff ff       	call   80104510 <memmove>
    len -= n;
    buf += n;
