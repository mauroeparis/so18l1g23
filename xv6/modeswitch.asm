...
_modeswitch:     file format elf32-i386
   ...
   f:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  21:	e8 aa 00 00 00       	call   d0 <strcmp>
  26:	83 c4 10             	add    $0x10,%esp
  29:	85 c0                	test   %eax,%eax
  2b:	74 3a                	je     67 <main+0x67>
  ...
  2d:	52                   	push   %edx
  2e:	52                   	push   %edx
  2f:	68 d5 07 00 00       	push   $0x7d5
  34:	ff 73 04             	pushl  0x4(%ebx)
  37:	e8 94 00 00 00       	call   d0 <strcmp>
  ...
  exit();
  43:	e8 aa 02 00 00       	call   2f2 <exit>
    printf(2, "init text mode\n");
  48:	50                   	push   %eax
  49:	50                   	push   %eax
  4a:	68 d7 07 00 00       	push   $0x7d7
  4f:	6a 02                	push   $0x2
  51:	e8 fa 03 00 00       	call   450 <printf>
    modeswitch(0);
  56:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  5d:	e8 38 03 00 00       	call   39a <modeswitch>
  62:	83 c4 10             	add    $0x10,%esp
  65:	eb dc                	jmp    43 <main+0x43>
    printf(2, "init graphic mode\n");
  67:	51                   	push   %ecx
  68:	51                   	push   %ecx
  69:	68 c2 07 00 00       	push   $0x7c2
  6e:	6a 02                	push   $0x2
  70:	e8 db 03 00 00       	call   450 <printf>
    modeswitch(1);
  75:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  7c:	e8 19 03 00 00       	call   39a <modeswitch>
  81:	83 c4 10             	add    $0x10,%esp
  84:	eb a7                	jmp    2d <main+0x2d>
    printf(2, "Usage: modeswitch 1|0 \n");
  86:	50                   	push   %eax
  87:	50                   	push   %eax
...
printf(int fd, char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb e7 07 00 00       	mov    $0x7e7,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 65d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 65f:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 664:	5b                   	pop    %ebx
 665:	5e                   	pop    %esi
 666:	5f                   	pop    %edi
 ...
 676:	72 ce                	jb     646 <free+0x26>
{
 ...
 697:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 69a:	a3 98 0a 00 00       	mov    %eax,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 98 0a 00 00    	mov    0xa98,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 47                	jae    748 <malloc+0x98>
    ...
    if(p == freep)
 701:	39 05 98 0a 00 00    	cmp    %eax,0xa98
 ...
 726:	e8 f5 fe ff ff       	call   620 <free>
  return freep;
 72b:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 754:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 757:	89 15 98 0a 00 00    	mov    %edx,0xa98
}
 ...
 777:	0a 00 00 
 77a:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 781:	0a 00 00 
    base.s.size = 0;
 784:	b8 9c 0a 00 00       	mov    $0xa9c,%eax
 789:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 790:	00 00 00 
